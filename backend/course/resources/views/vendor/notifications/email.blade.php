    ...
    <div class="email-container">
        <div class="email-header">
            @php
                $condition =
                    ...
                    $current_route == 'verification.send' ||
                    $current_route == 'admin.admins.store' ||
                    $current_route == 'admin.instructor.store' ||
                    $current_route == 'admin.student.store' ||
                    (isset($_GET['type']) && $_GET['type'] == 'registration');
            @endphp
            @if ($condition)
        ...
        <div class="email-body">
            ...
            @if (!empty($extraMessage))
                <p>{{ $extraMessage }}</p>
            @endif
            <p style="text-align: center;">{{ get_phrase('If you did not request this, you can ignore this email.') }}
            </p>
