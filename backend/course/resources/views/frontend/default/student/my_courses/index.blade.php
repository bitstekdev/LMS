                                ...
                                <div class="card Ecard g-card c-card">
                                    ...
                                    <div class="card-body entry-details">
                                        ...
                                        <div class="entry-title">
                                            <a href="{{ route('course.details', $course->course->slug) }}">
                                        ...
                                        @php
                                            $watch_history = App\Models\WatchHistory::where(
                                                'course_id',
                                                $course->course_id,
                                            )
                                        ...
                                        @else
                                            @if ($course_progress > 0 && $course_progress < 100.0)
                                                <a href="{{ $url }}"
                                                    class="eBtn learn-btn w-100 text-center mt-20 f-500">
                                                    {{ get_phrase('Continue') }}
                                                </a>
                                            @elseif ($course_progress == 100.0)
                                                <a href="{{ $url }}"
                                                    class="eBtn learn-btn w-100 text-center mt-20 f-500">
