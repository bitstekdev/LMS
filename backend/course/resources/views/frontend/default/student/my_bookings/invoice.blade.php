                ...
                <div class="col-lg-9">
                    <div class="my-panel purchase-history-panel">
                        <div class="invoice mt-5" id="invoice">
                            <div
                                class="top d-flex justify-content-between align-items-center border-1 border-bottom mb-5 pb-5">
                                <div>
                                    <h2><span>{{ get_phrase('Invoice') }} {{ $invoice }}</span></h2>
                                    <p class="description">{{ get_phrase('Date ') }}
                                        {{ date('d-M-Y', $booking->start_time) }}</p>
                                </div>
                                <div>
                                    <img src="{{ asset('assets/upload/dark_logo/dark-logo-1716985438.png') }}"
                                        alt="system logo" class="object-fit-cover rounded" width="200px">
                                </div>
                            </div>
                            ...
                            <div class="billing-area">
                                <div class="table-responsive">
                                    <table class="eTable table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>{{ $booking->schedule->subject->name }}</td>
                                                ...
                                                <td>{{ currency($booking->schedule->canTeach->price, 2) }}
                                                </td>
                                            </tr>
                    ...
                    <div class="d-flex align-items-center justify-content-end mt-3 gap-3">
                        ...
                        <a class="eBtn gradient" id="print" href="javascript:void(0);"
                            onclick="printableDiv('invoice')">{{ get_phrase('Print') }}</a>
                    </div>
                </div>
            </div>
