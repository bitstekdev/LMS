<div class="gradient-border radius-22 page-static-sidebar">
    <div class="ps-box ps-sidebar static-menu p-30">
        ...
        <div class="w-100 mt-3 px-4 text-center">
            ...
            <a href="https://twitter.com/intent/tweet?url={{ $share_url }}&text={{ $package->title }}&ref={{ $ref }}"
            ...
            <a href="https://www.linkedin.com/shareArticle?url={{ $share_url }}&title={{ $package->title }}&summary={{ $package->course_title }}&ref={{ $ref }}"
