                        ...
                        <div class="details-intro">
                            ...
                            <ul class="course-motion-top flex-wrap gap-4 justify-content-center">
                                ...
                                @if ($blog_details->keywords)
                                    <li>
                                        <img class="pro-20" src="{{ asset('assets/frontend/default/image/elearn.png') }}"
                                            alt="blog-tag">
                                        @php
                                ...
                                @endif
                                <li>
                                    <img class="pro-20" src="{{ asset('assets/frontend/default/image/elearn2.png') }}"
                                        alt="blog-comment">
                                    {{ $total_comments }}
                                </li>
                                <li>
                                    <img class="pro-20" src="{{ asset('assets/frontend/default/image/elearn3.png') }}"
                                        alt="created-date">
