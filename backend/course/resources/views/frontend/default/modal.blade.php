        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn p-0" data-bs-dismiss="modal" aria-label="Close"><i
                        class="fi fi-br-cross-small text-20 text-white"></i></button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="eBtn gradient border-none"
    ...
    <div class="modal-dialog">
        <div class="modal-content video_contain">
            <div class="modal-header video_model">
                ...
                <button type="button" class="btn-close video_close" data-bs-dismiss="modal"
