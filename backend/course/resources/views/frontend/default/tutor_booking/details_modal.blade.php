...
<div class="d-flex gap-4 flex-column flex-lg-row m-3">
    <div class="lg-w-329px">
        <div>
            ...
            <ul class="mb-20px d-flex gap-20px flex-column">
                <li class="d-flex align-items-center gap-3 justify-content-between flex-wrap">
                    ...
                    <p class="in-title-16px">
                        {{ date('h:i a', $schedule_details->start_time) . ' - ' . date('h:i a', $schedule_details->end_time) }}
                    </p>
                </li>
                <li class="d-flex align-items-center gap-3 justify-content-between flex-wrap">
                    <div class="d-flex align-items-center gap-6px">
                        <img src="{{ asset('assets/frontend/default/image/shopping-cart-gray-22.svg') }}"
                            alt="">
                ...
                <li class="d-flex align-items-center gap-3 justify-content-between flex-wrap">
                    ...
                    <p class="in-title-16px">
                        {{ total_booked_schedule_by_schedule_id($schedule_details->id) . ' ' . get_phrase('students') }}
                    </p>
                </li>
                <li class="d-flex align-items-center gap-3 justify-content-between flex-wrap">
                    <div class="d-flex align-items-center gap-6px">
            ...
            <a href="{{ route('message.inbox', $schedule_details->tutor_id) }}"
