        ...
        <div class="tutor-review-rating">
            <div class="d-flex align-items-center gap-2 mb-3">
                ...
                <ul class="tutor-rating-stars">
                    ...
                    @if ($halfStar)
                        <li>
                            <img src="{{ asset('assets/frontend/default/image/star-half-yellow-22.svg') }}"
                                alt="Half Star">
                        </li>
                    @endif
            ...
            <ul>
                @foreach ($starCounts as $star => $count)
                    ...
                    <li class="tutor-rating-progress-wrap">
                        ...
                        <div class="progress lms-progress tutor-rating-progress" role="progressbar"
                            ...
                            <div>
                                ...
                                <div class="comment-date-stars">
                                    ...
                                    <ul class="comment-stars-group">
                                        ...
                                        @for ($i = 0; $i < $fullStars; $i++)
                                            <li>
                                                <img src="{{ asset('assets/frontend/default/image/star-yellow2-16.svg') }}"
                                                    alt="Full Star">
                                            </li>
                                        @endfor
                                        ...
                                        @for ($i = 0; $i < $emptyStars; $i++)
                                            <li>
                                                <img src="{{ asset('assets/frontend/default/image/star-gray-16.svg') }}"
                                                    alt="Empty Star">
                                            </li>
                                        @endfor
                                    </ul>
                ...
                <form action="{{ route('tutor_review') }}" method="POST">
                    ...
                    <div class="mb-20px">
                        ...
                        <select class="lms-select lms-md-select lms-form-control max-w-469px" name="rating">
                            <option value="1" {{ optional($existingReview)->rating == 1 ? 'selected' : '' }}>
                                {{ get_phrase('One') }}</option>
                            <option value="2" {{ optional($existingReview)->rating == 2 ? 'selected' : '' }}>
                                {{ get_phrase('Two') }}</option>
                            <option value="3" {{ optional($existingReview)->rating == 3 ? 'selected' : '' }}>
                                {{ get_phrase('Three') }}</option>
                            <option value="4" {{ optional($existingReview)->rating == 4 ? 'selected' : '' }}>
                                {{ get_phrase('Four') }}</option>
                            <option value="5" {{ optional($existingReview)->rating == 5 ? 'selected' : '' }}>
                                {{ get_phrase('Five') }}</option>
                        </select>
                    </div>
                    <div class="mb-20px">
