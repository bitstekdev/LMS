                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb lms1-breadcrumb">
                                <li class="breadcrumb-item"><a href="#" class="d-flex align-items-center gap-12px">
                                        <img src="{{ asset('assets/frontend/default/image/home-purple-16.svg') }}"
                                            alt="">
                                        <span>{{ get_phrase('Home') }}</span>
                                    </a></li>
                                <li class="breadcrumb-item active" aria-current="page">{{ get_phrase('Tutor Details') }}
                                </li>
                            </ol>
                        </nav>
                    </div>
        ...
        <div class="container">
            <div class="row gx-20px mb-80px">
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="offcanvas-lg offcanvas-start lms1-tutor-offcanvas" tabindex="-1" id="offcanvasSidebar"
                            ...
                            <div class="lms1-tutor-sidebar">
                                <div class="lms-border-bottom pb-3 mb-3">
                                    ...
                                    <div class="tutor-star-rating d-flex align-items-center gap-1 justify-content-center">
                                        <img src="{{ asset('assets/frontend/default/image/star-yellow-12.svg') }}"
                                            alt="">
                                    ...
                                    <p class="in-subtitle-14px text-break text-center fw-normal">{{ $tutor_details->email }}
                                    </p>
                                </div>
                                ...
                                <ul class="mb-3 d-flex flex-column gap-3">
                                    <li class="d-flex align-items-center gap-1">
                                        <img class="me-2"
                                            src="{{ asset('assets/frontend/default/image/chalkboard-user-gray-20.svg') }}"
                                            alt="">
                                        <p class="in-title-14px">
                                            {{ total_schedule_by_tutor_id($tutor_details->id) . ' ' . get_phrase('Live schedule') }}
                                        </p>
                                    </li>
                                    <li class="d-flex align-items-center gap-1">
                                        <img class="me-2"
                                            src="{{ asset('assets/frontend/default/image/assignment-gray-20.svg') }}"
                                            alt="">
                                        <p class="in-title-14px">
                                    ...
                                    <li class="d-flex align-items-center gap-1">
                                        <img class="me-2"
                                            src="{{ asset('assets/frontend/default/image/memo-gray-20.svg') }}"
                                            alt="">
                                        <p class="in-title-14px">
                                ...
                                <div class="mb-3">
                                    <a href="{{ route('message.inbox', $tutor_details->id) }}"
                                        class="btn btn-outline-purple-sm2 w-100">
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="d-flex justify-content-end d-lg-none mb-3">
                        <button class="btn lms1-sidebar-btn" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasSidebar" aria-controls="offcanvasSidebar"><span
                                class=" fi-rr-bars-staggered"></span></button>
                    </div>
                    <!-- Tab Area -->
                    <div class="lms-content-card">
                        <ul class="nav nav-pills mb-20px lms-border-bottom column-gap-3 row-gap-2" id="pills-tab"
                            role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link tutor-tab-link svg-fill active" id="pills-one-tab"
                                    ...
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="#6E798A" />
                                        <path
                                            d="M12.9173 14.9999C12.7007 14.9999 12.484 14.9083 12.3257 14.7583C12.2507 14.6833 12.1923 14.5916 12.1507 14.4833C12.109 14.3833 12.084 14.2749 12.084 14.1666C12.084 14.0583 12.109 13.9499 12.1507 13.8499C12.1923 13.7416 12.2507 13.6499 12.3257 13.5749C12.5173 13.3833 12.809 13.2916 13.0756 13.3499C13.134 13.3583 13.184 13.3749 13.234 13.3999C13.284 13.4166 13.334 13.4416 13.384 13.4749C13.4257 13.4999 13.4673 13.5416 13.509 13.5749C13.659 13.7333 13.7507 13.9499 13.7507 14.1666C13.7507 14.3833 13.659 14.5999 13.509 14.7583C13.3507 14.9083 13.134 14.9999 12.9173 14.9999Z"
                                            fill="#6E798A" />
                                        <path
                                            d="M17.0827 8.2002H2.91602C2.57435 8.2002 2.29102 7.91686 2.29102 7.5752C2.29102 7.23353 2.57435 6.9502 2.91602 6.9502H17.0827C17.4243 6.9502 17.7077 7.23353 17.7077 7.5752C17.7077 7.91686 17.4243 8.2002 17.0827 8.2002Z"
                                            fill="#6E798A" />
                                        <path
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link tutor-tab-link" id="pills-two-tab" data-bs-toggle="pill"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link tutor-tab-link" id="pills-three-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-three" type="button" role="tab"
                                    aria-controls="pills-three" aria-selected="false">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M10.9994 17.8083C10.4494 18.5416 9.54934 18.5416 8.99934 17.8083L7.74934 16.1416C7.60767 15.9583 7.30768 15.8083 7.08268 15.8083H6.66602C3.33268 15.8083 1.66602 14.9749 1.66602 10.8083V6.6416C1.66602 3.30827 3.33268 1.6416 6.66602 1.6416H13.3327C16.666 1.6416 18.3327 3.30827 18.3327 6.6416V10.8083"
                                            stroke="#6E798A" stroke-width="1.2" stroke-miterlimit="10"
                                        ...
                                        <path
                                            ...
                                            stroke="#6E798A" stroke-width="1.2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M18.3333 18.3333L17.5 17.5" stroke="#6E798A" stroke-width="1.2"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M13.3301 9.16667H13.3375" stroke="#6E798A" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M9.99607 9.16667H10.0036" stroke="#6E798A" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M6.66209 9.16667H6.66957" stroke="#6E798A" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                    <span>Reviews</span>
                                </button>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <form action="">
                                            <div class="d-flex flex-wrap gap-12px align-items-start">
                                                <input type="text" name="date" placeholder="Select date"
                                                    class="form-control flat-date-picker date-picker-input w-277px"
                                                    id="date" />
                                                <a href="#" onclick="scheduleUpdateByDate()"
                                                    class="btn lms-btn-secondary">{{ get_phrase('Filter') }}</a>
                                            </div>
                                        </form>
                                    </div>
                                    <!-- Slider -->
                            ...
                            <div class="tab-pane fade" id="pills-three" role="tabpanel"
                                aria-labelledby="pills-three-tab" tabindex="0">
    ...
    <script>
        function scheduleUpdateByDate() {
            ...
            if (!selectedDate) {
                ...
                let url =
                    "{{ route('tutor.getSchedulesByCalenderDate', ['date' => ':selectedDate', 'tutorId' => ':tutorId']) }}";
        ...
        $(document).on('change', 'input[name="date-check"]', function() {
            ...
            let url =
                "{{ route('tutor.getSchedulesForDate', ['date' => ':selectedDate', 'tutorId' => ':tutorId']) }}";
            url = url.replace(":selectedDate", selectedDate);
            url = url.replace(":tutorId", tutorId);
