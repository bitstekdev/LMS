        ...
        <div class="container">
            <div class="row gx-20px mb-80px">
                ...
                <div class="col-xl-9 col-lg-8">
                    ...
                    <div
                        class="d-flex align-items-center gap-3 justify-content-between flex-wrap mb-3 flex-column flex-sm-row">
                        ...
                        <div class="d-flex align-items-center gap-14px flex-wrap flex-column flex-sm-row">
                            <form action="{{ route('tutor_list') }}" method="get">
                                <div class="lms1-search-wrap position-relative">
                                    <input type="text" class="form-control sm-search-input lms-w-298px" name="search"
                                        placeholder="Search instructor by name..." value="{{ request()->input('search') }}">
                                    <button type="submit" class="sm-search-btn">
                                        <img src="{{ asset('assets/frontend/default/image/search-white-14px.svg') }}"
                                            alt="">
                                    </button>
                                </div>
                            </form>
                    ...
                    <div class="row g-20px mb-30px">
                        @foreach ($tutors as $key => $tutor)
                            @php
                                ...
                                $lowestPrice = App\Models\TutorCanTeach::where('instructor_id', $tutor->id)->min(
                                    'price',
                                );
                                ...
                                <div class="tutor-bootcamp-card align-items-stretch">
                                    <div class="lms1-video-player tutor-bootcamp-video">
                                        <div class="plyr__video-embed lms-player{{ $index }}">
                                            <iframe
                                                src="{{ $tutor->video_url ?? 'https://www.youtube.com/watch?v=OHz0xIR8uwI' }}"
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <div class="d-flex gap-3 justify-content-between mb-3 flex-column flex-sm-row">
                                            <div>
                                                <div class="d-flex gap-2 mb-14px align-items-center">
                                                    ...
                                                    <div>
                                                        <div
                                                            class="mb-2 d-flex align-items-end column-gap-12px row-gap-2 flex-wrap">
                                                            <h4 class="in-title-18px">{{ $tutor->name }}</h4>
                                                            <div class="d-flex gap-1">
                                                                <img src="{{ asset('assets/frontend/default/image/star-yellow-14.svg') }}"
                                                                    alt="">
                                                                <h6 class="in-title-14px">
                                                                    {{ number_format($averageRating, 1) }}</h6>
                                                            </div>
                                                        </div>
                                                        @if ($tutor->about)
                                                            <p class="in-subtitle-14px">
                                                ...
                                                <ul class="d-flex column-gap-3 row-gap-2 flex-wrap mt-4">
                                                    <li class="d-flex gap-1 align-items-center in-title-14px">
                                                        <img src="{{ asset('assets/frontend/default/image/chalkboard-user-gray-18.svg') }}"
                                                            alt="">
                                                        <span>{{ total_schedule_by_tutor_id($tutor->id) . ' ' . get_phrase('Live schedule') }}</span>
                                                    </li>
                                                    <li class="d-flex gap-1 align-items-center in-title-14px">
                                                        <img src="{{ asset('assets/frontend/default/image/assientment-gray-18.svg') }}"
                                                            alt="">
                                                        <span>{{ total_booked_schedule_by_tutor_id($tutor->id) . ' ' . get_phrase('Booked schedule') }}</span>
                                                    </li>
                                                    <li class="d-flex gap-1 align-items-center in-title-14px">
                                                        <img src="{{ asset('assets/frontend/default/image/memo-gray-18.svg') }}"
                                                            alt="">
                                            ...
                                            <div>
                                                <p class="in-subtitle-14px mb-1 text-start text-sm-end text-nowrap">
                                                    {{ get_phrase('Session fee') }}</p>
                                                <h4 class="in-title-20px mb-2px text-start text-sm-end">
                                                    {{ currency($lowestPrice) }}</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex gap-2 flex-wrap pt-4">
                                            <a href="{{ route('tutor_schedule', [$tutor->id, slugify($tutor->name)]) }}"
                                                class="btn btn-purple-sm2">
                                                <span>{{ get_phrase('Book a session') }}</span>
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M5.33301 3.83325C5.05967 3.83325 4.83301 3.60659 4.83301 3.33325V1.33325C4.83301 1.05992 5.05967 0.833252 5.33301 0.833252C5.60634 0.833252 5.83301 1.05992 5.83301 1.33325V3.33325C5.83301 3.60659 5.60634 3.83325 5.33301 3.83325Z"
                                                        fill="white" />
                                                    <path
                                                        d="M10.667 3.83325C10.3937 3.83325 10.167 3.60659 10.167 3.33325V1.33325C10.167 1.05992 10.3937 0.833252 10.667 0.833252C10.9403 0.833252 11.167 1.05992 11.167 1.33325V3.33325C11.167 3.60659 10.9403 3.83325 10.667 3.83325Z"
                                                        fill="white" />
                                                    <path
                                                    ...
                                                    <path
                                                        ...
                                                        fill="white" />
                                                    <path
                                                        d="M7.99967 12C7.82634 12 7.65301 11.9267 7.52634 11.8067C7.40634 11.68 7.33301 11.5067 7.33301 11.3334C7.33301 11.2467 7.35301 11.16 7.38634 11.08C7.41968 10.9934 7.46634 10.92 7.52634 10.86C7.77301 10.6134 8.22634 10.6134 8.47301 10.86C8.53301 10.92 8.57967 10.9934 8.61301 11.08C8.64634 11.16 8.66634 11.2467 8.66634 11.3334C8.66634 11.5067 8.59301 11.68 8.47301 11.8067C8.34634 11.9267 8.17301 12 7.99967 12Z"
                                                        fill="white" />
                                                    <path
                                                        d="M10.3337 11.9999C10.1603 11.9999 9.98699 11.9266 9.86033 11.8066C9.80033 11.7466 9.75366 11.6733 9.72033 11.5866C9.68699 11.5066 9.66699 11.4199 9.66699 11.3333C9.66699 11.2466 9.68699 11.1599 9.72033 11.0799C9.75366 10.9933 9.80033 10.9199 9.86033 10.8599C10.0137 10.7066 10.247 10.6333 10.4603 10.6799C10.507 10.6866 10.547 10.6999 10.587 10.7199C10.627 10.7333 10.667 10.7533 10.707 10.78C10.7403 10.8 10.7737 10.8333 10.807 10.8599C10.927 10.9866 11.0003 11.1599 11.0003 11.3333C11.0003 11.5066 10.927 11.6799 10.807 11.8066C10.6803 11.9266 10.507 11.9999 10.3337 11.9999Z"
                                                        fill="white" />
                                                    <path
                                                        d="M13.6663 6.56006H2.33301C2.05967 6.56006 1.83301 6.33339 1.83301 6.06006C1.83301 5.78673 2.05967 5.56006 2.33301 5.56006H13.6663C13.9397 5.56006 14.1663 5.78673 14.1663 6.06006C14.1663 6.33339 13.9397 6.56006 13.6663 6.56006Z"
                                                        fill="white" />
                                                    <path
                                            ...
                                            <a href="{{ route('message.inbox', $tutor->id) }}"
                                                class="btn btn-outline-purple-sm">
