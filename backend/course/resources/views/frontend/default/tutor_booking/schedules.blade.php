                    ...
                    <ul class="mb-3 d-flex flex-column gap-12px">
                        <li class="d-flex service-activity-list-item gap-6px">
                            <img src="{{ asset('assets/frontend/default/image/timer-start-gray-20.svg') }}"
                                alt="">
                            <span
                                class="in-title-14px">{{ date('h:i a', $schedule->start_time) . ' - ' . date('h:i a', $schedule->end_time) }}</span>
                        </li>
                        <li class="d-flex service-activity-list-item gap-6px">
                        ...
                        <li class="d-flex service-activity-list-item gap-6px">
                            ...
                            <span
                                class="in-title-14px">{{ total_booked_schedule_by_schedule_id($schedule->id) . ' ' . get_phrase('slot booked') }}</span>
                        </li>
                    </ul>
                    <a onclick="tutorServiceModal('{{ route('view', ['path' => 'frontend.default.tutor_booking.details_modal', 'schedule_id' => $schedule->id]) }}')"
                        href="#" class="btn lms-sm-btn-outline-secondary w-100">
