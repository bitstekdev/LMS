                        ...
                        <div class="contact-icon">
                            <svg width="46" height="46" viewBox="0 0 46 46" fill="none"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M43.124 23C43.124 28.3375 41.0037 33.4564 37.2295 37.2305C33.4554 41.0047 28.3365 43.125 22.999 43.125C17.6615 43.125 12.5427 41.0047 8.7685 37.2305C4.99433 33.4564 2.87402 28.3375 2.87402 23C2.87402 20.357 3.39462 17.7399 4.40609 15.2982C5.41755 12.8564 6.90008 10.6378 8.76901 8.76897C10.6379 6.90017 12.8567 5.4178 15.2985 4.40651C17.7404 3.39522 20.3575 2.87481 23.0005 2.875C28.3379 2.875 33.4568 4.99531 37.231 8.76948C41.0052 12.5436 43.124 17.6625 43.124 23Z"
                                    fill="url(#paint0_linear_295_2553)"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M31.0371 4.54688C35.7665 6.61633 39.5251 10.4166 41.5423 15.1686C40.894 20.7791 38.0664 27.3126 33.0625 27.3126C27.3125 27.3126 24.4375 18.6876 24.4375 12.7464C24.4375 8.77312 27.2521 5.43813 31.0371 4.54688Z"
                                    fill="black" fill-opacity="0.1"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M34.5 25.875C28.7488 25.875 25.875 17.25 25.875 11.3091C25.875 6.6539 29.739 2.875 34.5 2.875C39.261 2.875 43.125 6.6539 43.125 11.3091C43.125 17.25 40.2512 25.875 34.5 25.875Z"
                                    fill="url(#paint2_linear_295_2553)"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M37.375 12.9375C37.375 14.0812 36.9206 15.1781 36.1119 15.9869C35.3031 16.7956 34.2062 17.25 33.0625 17.25C31.9188 17.25 30.8219 16.7956 30.0131 15.9869C29.2044 15.1781 28.75 14.0812 28.75 12.9375C28.75 11.7938 29.2044 10.6969 30.0131 9.8881C30.8219 9.07935 31.9188 8.625 33.0625 8.625C34.2062 8.625 35.3031 9.07935 36.1119 9.8881C36.9206 10.6969 37.375 11.7938 37.375 12.9375Z"
                                    fill="black" fill-opacity="0.11"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M38.8125 11.5C38.8125 12.6437 38.3581 13.7407 37.5494 14.5494C36.7406 15.3582 35.6437 15.8125 34.5 15.8125C33.3563 15.8125 32.2594 15.3582 31.4506 14.5494C30.6419 13.7407 30.1875 12.6437 30.1875 11.5C30.1875 10.3563 30.6419 9.25935 31.4506 8.4506C32.2594 7.64185 33.3563 7.1875 34.5 7.1875C35.6437 7.1875 36.7406 7.64185 37.5494 8.4506C38.3581 9.25935 38.8125 10.3563 38.8125 11.5Z"
                                    fill="url(#paint3_linear_295_2553)"></path>
                                <defs>
                                    <linearGradient id="paint0_linear_295_2553" x1="24.438" y1="43.125" x2="23.0005"
                                        y2="4.31264" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#1AAFFA"></stop>
                                        <stop offset="1" stop-color="#66D9FF"></stop>
                                    </linearGradient>
                                    <linearGradient id="paint1_linear_295_2553" x1="22.9997" y1="41.6875" x2="22.9997"
                                        y2="5.75" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#66D9FF"></stop>
                                        <stop offset="1" stop-color="white"></stop>
                                    </linearGradient>
                                    <linearGradient id="paint2_linear_295_2553" x1="34.5" y1="24.4375" x2="34.5"
                                        y2="4.3125" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#62E8AF"></stop>
                                        <stop offset="1" stop-color="#A1FFD8"></stop>
                                    </linearGradient>
                                    <linearGradient id="paint3_linear_295_2553" x1="34.5" y1="15.8125" x2="34.5"
                                        y2="7.1875" gradientUnits="userSpaceOnUse">
                    ...
                    <div class="ol-card p-4 card contact-card Ecard g-card c-card">
                        <div class="contact-icon">
                            <svg width="46" height="46" viewBox="0 0 46 46" fill="none"
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_295_2563" x1="2.94888" y1="23" x2="43.0508"
                                        y2="23" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#FF81FF"></stop>
                                        <stop offset="1" stop-color="#A93AFF"></stop>
                                    </linearGradient>
                                    <linearGradient id="paint1_linear_295_2563" x1="5.51179" y1="35.1973"
                                        x2="30.1388" y2="15.2501" gradientUnits="userSpaceOnUse">
                    ...
                    <div class="ol-card p-4 card contact-card Ecard g-card c-card">
                        <div class="contact-icon">
                            <svg width="46" height="46" viewBox="0 0 46 46" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M7.1875 37.1939C5.95323 36.8747 4.85995 36.1545 4.07938 35.1466C3.29881 34.1386 2.87517 32.8999 2.875 31.625V15.8125C2.875 14.2875 3.4808 12.825 4.55914 11.7466C5.63747 10.6683 7.10001 10.0625 8.625 10.0625H25.875C27.4 10.0625 28.8625 10.6683 29.9409 11.7466C31.0192 12.825 31.625 14.2875 31.625 15.8125V31.625C31.6252 32.3801 31.4765 33.1278 31.1875 33.8254C30.8984 34.523 30.4745 35.1567 29.9402 35.6903C29.4067 36.2245 28.773 36.6484 28.0754 36.9375C27.3778 37.2265 26.6301 37.3752 25.875 37.375H16.3171L9.52344 42.8102C9.31199 42.9795 9.05701 43.0856 8.78789 43.1163C8.51876 43.147 8.24644 43.101 8.0023 42.9837C7.75816 42.8663 7.55215 42.6824 7.40799 42.4531C7.26383 42.2238 7.1874 41.9584 7.1875 41.6875V37.1939Z"
                                    fill="url(#paint0_linear_295_2545)"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M38.8125 30.0064V34.5C38.8132 34.7711 38.7371 35.0369 38.593 35.2665C38.449 35.4962 38.2429 35.6804 37.9985 35.7979C37.7542 35.9153 37.4816 35.9612 37.2122 35.9302C36.9429 35.8992 36.6878 35.7926 36.4766 35.6227L29.6829 30.1875H14.375C12.85 30.1875 11.3875 29.5817 10.3091 28.5034C9.2308 27.425 8.625 25.9625 8.625 24.4375V8.625C8.625 7.10001 9.2308 5.63747 10.3091 4.55914C11.3875 3.4808 12.85 2.875 14.375 2.875H37.375C38.9 2.875 40.3625 3.4808 41.4409 4.55914C42.5192 5.63747 43.125 7.10001 43.125 8.625V24.4375C43.1248 25.7124 42.7012 26.9511 41.9206 27.9591C41.14 28.967 40.0468 29.6872 38.8125 30.0064Z"
                                    fill="url(#paint1_linear_295_2545)"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="black" fill-opacity="0.1"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M23 17.25C23 18.0125 23.3029 18.7438 23.8421 19.2829C24.3812 19.8221 25.1125 20.125 25.875 20.125C26.6375 20.125 27.3688 19.8221 27.9079 19.2829C28.4471 18.7438 28.75 18.0125 28.75 17.25C28.75 16.4875 28.4471 15.7562 27.9079 15.2171C27.3688 14.6779 26.6375 14.375 25.875 14.375C25.1125 14.375 24.3812 14.6779 23.8421 15.2171C23.3029 15.7562 23 16.4875 23 17.25Z"
                                    fill="url(#paint2_linear_295_2545)"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M14.375 17.25C14.375 18.0125 14.6779 18.7438 15.2171 19.2829C15.7562 19.8221 16.4875 20.125 17.25 20.125C18.0125 20.125 18.7438 19.8221 19.2829 19.2829C19.8221 18.7438 20.125 18.0125 20.125 17.25C20.125 16.4875 19.8221 15.7562 19.2829 15.2171C18.7438 14.6779 18.0125 14.375 17.25 14.375C16.4875 14.375 15.7562 14.6779 15.2171 15.2171C14.6779 15.7562 14.375 16.4875 14.375 17.25Z"
                                    fill="url(#paint3_linear_295_2545)"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M31.625 17.25C31.625 18.0125 31.9279 18.7438 32.4671 19.2829C33.0062 19.8221 33.7375 20.125 34.5 20.125C35.2625 20.125 35.9938 19.8221 36.5329 19.2829C37.0721 18.7438 37.375 18.0125 37.375 17.25C37.375 16.4875 37.0721 15.7562 36.5329 15.2171C35.9938 14.6779 35.2625 14.375 34.5 14.375C33.7375 14.375 33.0062 14.6779 32.4671 15.2171C31.9279 15.7562 31.625 16.4875 31.625 17.25Z"
                                    fill="url(#paint4_linear_295_2545)"></path>
                                <defs>
                                    <linearGradient id="paint0_linear_295_2545" x1="5.75" y1="34.5"
                                        x2="30.1875" y2="12.9375" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#7F3AF9"></stop>
                                        <stop offset="1" stop-color="#B560FF"></stop>
                                    </linearGradient>
                                    <linearGradient id="paint1_linear_295_2545" x1="11.5" y1="27.3125"
                                        x2="38.8125" y2="4.3125" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#18AEFA"></stop>
                                        <stop offset="1" stop-color="#83E1FF"></stop>
                                    </linearGradient>
                                    <linearGradient id="paint2_linear_295_2545" x1="24.4375" y1="20.125"
                                        x2="27.3125" y2="15.8125" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#82E3FF"></stop>
                                        <stop offset="1" stop-color="white"></stop>
                                    </linearGradient>
                                    <linearGradient id="paint3_linear_295_2545" x1="15.8125" y1="20.125"
                                        x2="18.6875" y2="15.8125" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#82E3FF"></stop>
                                        <stop offset="1" stop-color="white"></stop>
                                    </linearGradient>
                                    <linearGradient id="paint4_linear_295_2545" x1="33.0625" y1="20.125"
                                        x2="35.9375" y2="15.8125" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#82E3FF"></stop>
                                        <stop offset="1" stop-color="white"></stop>
                                    </linearGradient>
                                </defs>
                ...
                <div class="col-lg-5">
                    <div class="conatact-map">
                        <iframe class="border-0"
                            src="https://maps.google.com/maps?q={{ $contact_info['location'] }}&hl=es&z=14&amp;output=embed"
                        ...
                        <form action="{{ route('contact.store') }}" method="post" class="global-form mt-25"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="message" cols="30" rows="10"
                                    class="form-control @error('message') border border-danger @enderror" placeholder="Your message here ..."></textarea>
                            </div>

                            @if (get_frontend_settings('recaptcha_status'))
                                <button class="mt-20 g-recaptcha"
                                    data-sitekey="{{ get_frontend_settings('recaptcha_sitekey') }}"
                                    data-callback='onContactSubmit'
                                    data-action='submit'>{{ get_phrase('Send Message') }}</button>
                            @else
