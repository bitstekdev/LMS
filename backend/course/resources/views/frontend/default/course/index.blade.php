                    ...
                    <div class="eNtry-breadcum">
                        ...
                        <div class="row row-gap-3">
                            ...
                            <div class="col-auto col-md-4 col-lg-4">
                                <span
                                    class="showing-text mt-4 d-inline-block">{{ get_phrase('Showing') . ' ' . count($courses) . ' ' . get_phrase('of') . ' ' . $courses->total() . ' ' . get_phrase('data') }}</span>
                            </div>
                                        ...
                                        <li class="@if ($layout == 'grid') active @endif">
                                            <a href="#" class="color gradient layout" id="grid">
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                                    ...
                                                    <defs>
                                                        <linearGradient id="paint0_linear_221_2436" x1="0.416687"
                                                            y1="0.416992" x2="13.5833" y2="13.5836"
