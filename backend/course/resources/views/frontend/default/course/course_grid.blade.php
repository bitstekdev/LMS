        ...
        <div class="courses-img">
            ...
            @auth
                @if (in_array($course->id, $wishlist))
                    <span data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Remove from wishlist') }}"
                        class="heart toggleWishItem inList" id="item-{{ $course->id }}"><i
                            class="fa-regular fa-heart"></i></span>
                @else
                    <span data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Add to wishlist') }}"
                        class="heart toggleWishItem" id="item-{{ $course->id }}"><i
                            class="fa-regular fa-heart"></i></span>
                @endif
            @endauth
