        ...
        <div class="col-xl-7">
            <div class="ol-card p-4">
                <div class="ol-card-body">
                    <form action="{{ route('instructor.manage.profile.update') }}" method="post"
                        ...
                        <div class="fpb7 mb-2">
                            <label
                                class="form-label ol-form-label">{{ get_phrase('Youtube video link for tutor intro') }}</label>
                            <input type="text" class="form-control ol-form-control" name="video_url"
                                value="{{ $auth->video_url }}" />
                        </div>
