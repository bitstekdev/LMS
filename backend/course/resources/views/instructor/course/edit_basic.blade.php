    ...
    <div class="col-sm-10">
        <select class="ol-select2" name="language" required>
            ...
            @foreach (App\Models\Language::get() as $language)
                <option value="{{ strtolower($language->name) }}" @if ($course_details->language == strtolower($language->name)) selected @endif
        ...
        <div class="eRadios">
            <div class="form-check">
                <input type="radio" value="active" name="status" class="form-check-input eRadioSuccess"
                    id="status_active" @if ($course_details->status == 'active') checked @endif required disabled>
            ...
            <div class="form-check">
                <input type="radio" value="upcoming" name="status" class="form-check-input eRadioInfo"
                    id="status_upcoming" @if ($course_details->status == 'upcoming') checked @endif required disabled>
            ...
            <div class="form-check">
                <input type="radio" value="deactive" name="status" class="form-check-input eRadioDark"
                    id="status_deactive" @if ($course_details->status == 'deactive') checked @endif required disabled>
