...
<div class="row mb-3">
    <label for="category_id" class="form-label ol-form-label col-sm-2 col-form-label">{{ get_phrase('Category') }}<span
            class="text-danger ms-1">*</span></label>
    <div class="col-sm-10">
...
<div class="row mb-3">
    <label for="level"
        class="form-label ol-form-label col-sm-2 col-form-label">{{ get_phrase('Course level') }}<span
            class="text-danger ms-1">*</span></label>
    <div class="col-sm-10">
...
<div class="row mb-3">
    <label for="language" class="form-label ol-form-label col-sm-2 col-form-label">{{ get_phrase('Made in') }} <span
            class="text-danger ms-1">*</span></label>
    <div class="col-sm-10">
        <select class="form-control ol-form-control select2" name="language" id="language" required>
            ...
            @foreach (App\Models\Language::get() as $language)
                <option value="{{ strtolower($language->name) }}" class="text-capitalize">{{ $language->name }}
                </option>
            @endforeach
        </select>
    </div>
...
<div class="row mb-3 ">
    <label for="course_status" class="col-sm-2 col-form-label">{{ get_phrase('Create as') }} <span
            class="text-danger ms-1">*</span></label>
    <div class="col-sm-10">
        <div class="eRadios">
            ...
            <div class="form-check">
                <input type="radio" value="deactive" name="status" class="form-check-input eRadioDark"
                    id="status_deactive" required>
