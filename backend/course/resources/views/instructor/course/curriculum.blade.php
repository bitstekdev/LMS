<div class="w-100">
    ...
    <div class="mb-3 d-flex gap-2 align-items-center flex-wrap">
        <a href="#"
            onclick="ajaxModal('{{ route('modal', ['instructor.course.create_section', 'id' => $course_details->id]) }}', '{{ get_phrase('Add new section') }}')"
            class="btn ol-btn-light ol-btn-sm">{{ get_phrase('Add section') }}
        </a>

        @if ($sections->count() > 0)
            <a href="#"
                onclick="ajaxModal('{{ route('modal', ['instructor.course.lesson_type', 'id' => $course_details->id]) }}', '{{ get_phrase('Add new lesson') }}')"
                class="btn ol-btn-light ol-btn-sm">{{ get_phrase('Add lesson') }}</a>

            <a href="#"
                onclick="ajaxModal('{{ route('modal', ['instructor.quiz.create', 'id' => $course_details->id]) }}', '{{ get_phrase('Add new quiz') }}')"
                class="btn ol-btn-light ol-btn-sm">{{ get_phrase('Add quiz') }}</a>

            <a href="#"
                onclick="ajaxModal('{{ route('modal', ['instructor.course.section_sort', 'id' => $course_details->id]) }}', '{{ get_phrase('Sort sections') }}')"
    ...
    <ul class="ol-my-accordion">
            ...
            <li class="single-accor-item">
                <div class="accordion-btn-wrap">
                    ...
                    <div class="accordion-button-buttons">
                        ...
                        @if ($lessons->count() > 0)
                            <a href="#"
                                onclick="ajaxModal('{{ route('modal', ['instructor.course.lesson_sort', 'id' => $section->id]) }}', '{{ get_phrase('Sort lessons') }}'); event.stopPropagation();"
                                class="btn btn-outline-gray-small">{{ get_phrase('Sort Lessons') }}
                            </a>
                        @endif

                        <a href="#" data-bs-toggle="tooltip" title="{{ get_phrase('Edit section') }}"
                            onclick="ajaxModal('{{ route('modal', ['instructor.course.section_edit', 'id' => $section->id]) }}', '{{ get_phrase('Edit section') }}'); event.stopPropagation();"
                            class="edit">
                                    ...
                                    <div class="buttons">
                                        @if ($lesson->lesson_type == 'quiz')
                                            ...
                                            <a href="#" data-bs-toggle="tooltip"
                                                ...
                                                onclick="ajaxModal('{{ route('modal', ['instructor.questions.index', 'id' => $lesson->id]) }}', '{{ get_phrase('Questions') }}', 'modal-lg')"
                                                class="edit-delete">
                                            ...
                                            <a href="#" data-bs-toggle="tooltip"
                                                ...
                                                onclick="ajaxModal('{{ route('modal', ['instructor.quiz.edit', 'id' => $lesson->id]) }}', '{{ get_phrase('Edit quiz') }}')"
                                                class="edit-delete">
                                                <span class="fi-rr-pencil"></span>
                                            </a>
                                        @endif
                                        ...
                                        @if ($lesson->lesson_type != 'quiz')
                                            <a href="#" data-bs-toggle="tooltip"
                                                ...
                                                onclick="ajaxModal('{{ route('modal', ['instructor.course.lesson_edit', 'id' => $lesson->id]) }}', '{{ get_phrase('Edit lesson') }}')"
                                                class="edit-delete">
                                                <span class="fi-rr-pencil"></span>
                                            </a>
                                        @endif
        ...
        @empty
            <li>
                <div class="row">
                    <div class="col-md-8">
                        <a onclick="ajaxModal('{{ route('modal', ['instructor.course.create_section', 'id' => $course_details->id]) }}', '{{ get_phrase('Add new section') }}')"
