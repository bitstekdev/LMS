    ...
    <div class="ol-card radius-8px">
        <div class="ol-card-body my-3 py-12px px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                ...
                <a href="#"
                    onclick="ajaxModal('{{ route('modal', ['instructor.resume.add_education']) }}', '{{ get_phrase('Add New Education') }}')"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="#"
                                                                        onclick="ajaxModal('{{ route('modal', ['instructor.resume.edit_education', 'index' => $index]) }}', '{{ get_phrase('Update Education') }}')">{{ get_phrase('Edit') }}</a>
                                                                </li>
                                                                <li>
