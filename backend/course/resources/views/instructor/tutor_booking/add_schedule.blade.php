    ...
    <div class="ol-body-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-7">
                    <div class="ol-card">
                        <form class="required-form" action="{{ route('instructor.schedule_store') }}" method="post"
                            ...
                            <div class="ol-card-body mb-20px p-20px">
                                            ...
                                            <select class="ol-select2" name="category_id" id="category_id" required>
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->category_id }}">
                                                        {{ $category->category_to_tutorCategory->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="paid-section" id="paid-section">
                                            ...
                                            <div class="d-flex gap-3">
                                                ...
                                                <div class="form-check">
                                                    <input type="radio" name="tution_type" value="1"
                                                        class="form-check-input form-check-input-radio" id="single_1"
                                                        name="1_tution_type_indentify"
                                                ...
                                                <div class="form-check">
                                                    <input type="radio" name="tution_type" value="0"
                                                        class="form-check-input form-check-input-radio"
                                                        id="selected_class_1" name="1_tution_type_indentify"
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label ol-form-label"
                                                for="start_time">{{ get_phrase('Schedule start time') }}<span
                                                    class="required">*</span></label>
                                            <input type="datetime-local" class="form-control ol-form-control"
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="d-flex" style="justify-content: right;">
                                                        <label class="form-label ol-form-label col-sm-2 w-100 float-end"
                                                            for="check_all_days">{{ get_phrase('Check all') }}</label><input
                                                            type="checkbox"
                                                            class="form-check-input form-check-input-checkbox"
                                                            id="check_all_days">
                                                    </div>
                                                </div>
                                                <div class="form-check form-check-checkbox d-flex justify-content-between">
                                                    <div>
                                                        <input type="checkbox"
                                                            class="form-check-input form-check-input-checkbox"
                                                            id="sunday_1" name="1_day[]" value="sunday">
                                                        <label id="label_sunday_1"
                                                            for="sunday_1"><?php echo get_phrase('sunday'); ?></label>
                                                    </div>
                                                    <div>
                                                        <input type="checkbox"
                                                            class="form-check-input form-check-input-checkbox"
                                                            id="monday_1" name="1_day[]" value="monday">
                                                        <label id="label_monday_1"
                                                            for="monday_1"><?php echo get_phrase('monday'); ?></label>
                                                    </div>

                                                    <div>
                                                        <input type="checkbox"
                                                            class="form-check-input form-check-input-checkbox"
                                                            id="tuesday_1" name="1_day[]" value="tuesday">
                                                        <label id="label_tuesday_1"
                                                            for="tuesday_1"><?php echo get_phrase('tuesday'); ?></label>
                                                    </div>

                                                    <div>
                                                        <input type="checkbox"
                                                            class="form-check-input form-check-input-checkbox"
                                                            id="wednesday_1" name="1_day[]" value="wednesday">
                                                        <label id="label_wednesday_1"
                                                            for="wednesday_1"><?php echo get_phrase('wednesday'); ?></label>
                                                    </div>

                                                    <div>
                                                        <input type="checkbox"
                                                            class="form-check-input form-check-input-checkbox"
                                                            id="thursday_1" name="1_day[]" value="thursday">
                                                        <label id="label_thursday_1"
                                                            for="thursday_1"><?php echo get_phrase('thursday'); ?></label>
                                                    </div>

                                                    <div>
                                                        <input type="checkbox"
                                                            class="form-check-input form-check-input-checkbox"
                                                            id="friday_1" name="1_day[]" value="friday">
                                                        <label id="label_friday_1"
                                                            for="friday_1"><?php echo get_phrase('friday'); ?></label>
                                                    </div>

                                                    <div>
                                                        <input type="checkbox"
                                                            class="form-check-input form-check-input-checkbox"
                                                            id="saturday_1" name="1_day[]" value="saturday">
                                                        <label id="label_saturday_1"
                                                            for="saturday_1"><?php echo get_phrase('saturday'); ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="ol-select2" id="duration" name="duration">
                                        ...
                                        @for ($i = 60; $i <= 300; $i += 15)
                                            <option value="{{ $i }}">
                                                {{ intdiv($i, 60) }}
                                                hour{{ intdiv($i, 60) > 1 ? 's' : '' }}{{ $i % 60 > 0 ? ' ' . $i % 60 . ' minutes' : '' }}
                                            </option>
                                        @endfor
                                    </select>
                                ...
                                <button type="button" class="btn ol-btn-primary"
                                    onclick="checkRequiredFields_schedules()"><?php echo get_phrase('Save Schedule'); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        function checkRequiredFields_schedules() {
            ...
            if ($('#selected_class_1').is(':checked')) {
                if ($('#sunday_1').is(':checked') || $('#monday_1').is(':checked') || $('#tuesday_1').is(':checked') || $(
                        '#wednesday_1').is(':checked') || $('#thursday_1').is(':checked') || $('#friday_1').is(
                        ':checked') || $('#saturday_1').is(':checked')) {
