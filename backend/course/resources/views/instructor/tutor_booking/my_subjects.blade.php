    ...
    <div class="ol-card radius-8px">
        <div class="ol-card-body my-3 py-12px px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                ...
                <a onclick="ajaxModal('{{ route('modal', ['instructor.tutor_booking.subject_add']) }}', '{{ get_phrase('Add new subject') }}')"
                    ...
                    <div class="col-md-12 pb-3">
                        <ul class="ol-my-accordion">
                            ...
                            @foreach ($categories as $category)
                                @php
                                    $subjects = App\Models\TutorCanTeach::where(
                                        'category_id',
                                    ...
                                    <div class="accordion-btn-wrap">
                                        <div class="accordion-btn-title d-flex align-items-center">
                                            ...
                                            <h4 class="title">{{ ++$index }}.
                                                {{ $category->category_to_tutorCategory->name }}</h4>
                                        </div>
                                        ...
                                        <ul class="list-group-3">
                                            @if ($subjects->count() > 0)
                                                @foreach ($subjects as $subject)
                                                    <li>
                                                        <h4 class="title">{{ $subject->category_to_tutorSubjects->name }}
                                                        </h4>
