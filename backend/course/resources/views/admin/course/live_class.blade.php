                        ...
                        <tr>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_img">
                                        <img class="img-fluid rounded-circle image-45" width="40" height="40"
                                            src="{{ get_image($live_class->user->photo) }}" />
                                    </div>
                                    <div class="ms-1">
                            ...
                            <td class="p-0 pt-3">
                                <p class="sub-title text-12px">
                                    {{ date('d M Y - h:i A', strtotime($live_class->class_date_and_time)) }}</p>
                            </td>
                            <td class="p-0 pt-3">
                                <a href="{{ route('admin.live.class.start', ['id' => $live_class->id]) }}"
                                ...
                                <a href="#" class="btn py-0 px-1 text-danger"
                                    onclick="confirmModal('{{ route('admin.live.class.delete', ['id' => $live_class->id]) }}')"
