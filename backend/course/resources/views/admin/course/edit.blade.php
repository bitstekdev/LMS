...
@section('content')
    ...
    <div class="col-md-12">
        <form class="ajaxForm" action="{{ route('admin.course.update', $course_details->id) }}" method="post"
                        ...
                        <div class="ol-sidebar-tab">
                            <div class="d-flex flex-column">
                                ...
                                <a class="nav-link @if ($tab == 'live-class') active @endif"
                                    href="{{ route('admin.course.edit', [$param, 'tab' => 'live-class']) }}">
