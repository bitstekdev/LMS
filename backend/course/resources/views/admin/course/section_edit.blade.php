    ...
    <div class="row">
        <div class="col-12">
            <div class="mb-3">
                ...
                <input type="text" name="up_title" class="form-control ol-form-control" id="category_name"
                    placeholder="{{ get_phrase('Enter title') }}" aria-label="{{ get_phrase('Enter title') }}"
                    value="{{ $sections->title }}" required />
            </div>
