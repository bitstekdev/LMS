    ...
    <div class="ol-card radius-8px">
        <div class="ol-card-body my-3 py-12px px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                ...
                <a href="{{ route('admin.student.enroll') }}"
    ...
    <div class="ol-card">
        <div class="ol-card-body p-3">
            <div class="row mb-3 mt-3 row-gap-3">
                ...
                <div class="col-md-6">
                    <form class="w-100" action="{{ route('admin.enroll.history') }}" method="get"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                                    ...
                                                    <div class="ms-1">
                                                        <h4 class="title fs-14px">{{ get_user_info($row->user_id)->name }}
                                                        </h4>
                                            ...
                                            <td>
                                                <div class="dAdmin_info_name min-w-250px">
                                                    <p><a href="{{ route('admin.course.edit', $row->course_id) }}"
                                                            target="_blank">{{ get_course_info($row->course_id)->title }}</a>
                                                    </p>
                                                ...
                                                <div class="dAdmin_info_name min-w-250px">
                                                    @if ($row->expiry_date)
                                                        @if ($row->expiry_date >= time())
                                                            <p><span class="badge bg-success text-white">{{ date('d M Y', $row->expiry_date) . ' ' . date('h:i A', $row->expiry_date) }}
                                                            </p>
                                                        @else
                                                            <p><span class="badge bg-danger text-white">{{ date('d M Y', $row->expiry_date) . ' ' . date('h:i A', $row->expiry_date) }}
                                                            </p>
                                                        @endif
                                                    @else
                                                        <p><span
                                                                class="badge bg-success text-white">{{ get_phrase('Lifetime access') }}</span>
                                                        </p>
                                                    @endif
                                                </div>
                                            </td>
