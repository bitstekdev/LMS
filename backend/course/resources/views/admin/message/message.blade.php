            ...
            <div class="message-sidebar-area">
                <div class="message-sidebar-header">
                    <div class="back-and-plus mb-3 d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <a href="#"
                            onclick="ajaxModal('{{ route('modal', ['view_path' => 'admin.message.message_new']) }}', '{{ get_phrase('Create a new thread') }}')"
                            data-bs-toggle="tooltip" title="{{ get_phrase('New message') }}"
                    ...
                    <form action="">
                        <div class="message-sidebar-search">
                            ...
                            <input type="search" class="form-control"
                                onkeyup="loadView('{{ route('view', ['path' => 'admin.message.message_left_side_bar']) }}?thread_code={{ $thread_code ? $thread_code : '' }}&search='+$(this).val(), '#message-user-list')"
