    ...
    <div class="ol-card radius-8px">
        <div class="ol-card-body my-3 py-12px px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                ...
                <a onclick="ajaxModal('{{ route('modal', ['admin.newsletter.create']) }}', '{{ get_phrase('Add Newsletter') }}')"
                                    ...
                                    <li class="single-accor-item">
                                        <div class="accordion-btn-wrap">
                                            ...
                                            <div class="accordion-button-buttons">
                                                <a onclick="ajaxModal('{{ route('modal', ['admin.newsletter.send', 'id' => $newsletter->id]) }}', '{{ get_phrase('Send newsletter') }}')"
                                                    data-bs-toggle="tooltip" title="{{ get_phrase('Send Newsletter') }}"
                                                    href="#" class="edit"><span
                                                        class="fi-rr-paper-plane"></span></a>
                                                <a onclick="ajaxModal('{{ route('modal', ['admin.newsletter.edit', 'id' => $newsletter->id]) }}', '{{ get_phrase('Edit Newsletter') }}')"
                                                    data-bs-toggle="tooltip" title="{{ get_phrase('Edit') }}"
                                                    href="#" class="edit"><span
                                                ...
                                                <a onclick="confirmModal('{{ route('admin.newsletter.delete', $newsletter->id) }}')"
                                                    ...
                                                    href="#" class="delete"><span class="fi-rr-trash"></span></a>
                                            </div>
                                        </div>
