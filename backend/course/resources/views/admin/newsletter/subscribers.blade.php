                                ...
                                <ul class="dropdown-list">
                                    <li>
                                        <a class="dropdown-item" href="#"
                                            onclick="downloadPDF('.print-table', 'newsletter-subscribers')"><i
                                    ...
                                    @foreach ($subscribers as $key => $subscriber)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($user_details)
                                                    <span
                                                        class="badge bg-success">{{ get_phrase('Registered User') }}</span>
                                                @else
                                                    <span
                                                        class="badge bg-warning">{{ get_phrase('Not Registered') }}</span>
                                                @endif
                                            </td>
