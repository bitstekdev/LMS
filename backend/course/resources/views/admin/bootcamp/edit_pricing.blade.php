        ...
        <div class="eRadios">
            <div class="form-check">
                <input type="radio" name="is_paid" value="1" class="form-check-input eRadioSuccess" id="paid"
                    onchange="$('#paid-section').slideDown(200)" @if ($bootcamp_details->is_paid == 1) checked @endif>
            ...
            <div class="form-check">
                <input type="radio" name="is_paid" value="0" class="form-check-input eRadioSuccess"
                    ...
                    @if ($bootcamp_details->is_paid != 1) checked @endif>
...
<div class="paid-section @if ($bootcamp_details->is_paid != 1) d-hidden @endif" id="paid-section">
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="number" name="price" value="{{ $bootcamp_details->price }}"
            ...
            <div class="eRadios">
                <div class="form-check">
                    <input type="checkbox" name="discount_flag" value="1" class="form-check-input eRadioSuccess"
                        id="discount_flag" @if ($bootcamp_details->discount_flag == 1) checked @endif>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="number" name="discounted_price" value="{{ $bootcamp_details->discounted_price }}"
                class="form-control ol-form-control" id="discounted_price" min="1" step=".01"
