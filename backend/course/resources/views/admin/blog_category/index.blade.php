                    ...
                    <div class="ol-card card-hover">
                        <div class="ol-card-body px-20px py-3 d-flex justify-content-between">
                            <div>
                                ...
                                <p class="sub-title text-12px mt-2">{{ get_phrase('Total number of blog') }}
                                    {{ count_blogs_by_category($category->id) }}</p>
                            </div>
                            ...
                            <div class="dropdown ol-icon-dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="javascript:void(0);"
                                            onclick="ajaxModal('{{ route('modal', ['admin.blog_category.edit', 'id' => $category->id]) }}', '{{ get_phrase('Edit Category') }}')">{{ get_phrase('Edit') }}</a>
                                    </li>
                                    <li><a class="dropdown-item" href="javascript:void(0);"
                                            onclick="confirmModal('{{ route('admin.blog.category.delete', $category->id) }}')">{{ get_phrase('Delete') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
