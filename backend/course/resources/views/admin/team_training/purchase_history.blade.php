                                ...
                                <ul class="dropdown-list">
                                    <li>
                                        <a class="dropdown-item" href="#"
                                            onclick="downloadPDF('.print-table', 'team_training_payment')"><i
                            ...
                            <table class="eTable eTable-2 print-table table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="print-d-none text-center">{{ get_phrase('Options') }}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                                ...
                                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                                    <div class="dAdmin_profile_img">
                                                        <img class="img-fluid rounded-circle image-45" width="40"
                                                            height="40"
                                                            src="{{ get_image(get_user_info($report->user_id)->photo) }}">
                                                    </div>
                                                    <div class="ms-1 mt-1">
                                                        <h4 class="title fs-14px">
                                                            {{ get_user_info($report->user_id)->name }}</h4>
                                            ...
                                            <td>
                                                <div class="sub-title2 text-12px min-w-150px">
                                                    ...
                                                    <p><span>{{ get_phrase('Admin :') }}
                                                        </span>{{ currency($report->admin_revenue, 2) }}</p>
                                                    <p><span>{{ get_phrase('Author :') }}
                                                        </span>{{ currency($report->instructor_revenue, 2) }}</p>
                                                </div>
                                            </td>
                                            ...
                                            <td class="print-d-none">
                                                <div
                                                    class="sub-title2 text-12px text-capitalize d-flex justify-content-center">
                                                    <a href="{{ route('admin.team.packages.purchase.invoice', $report->id) }}"
