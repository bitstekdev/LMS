...
@push('title', get_phrase('Manage Pcakages'))
    ...
    <div class="ol-card radius-8px">
        <div class="ol-card-body py-12px px-20px my-3">
            <div class="d-flex align-items-center justify-content-between flex-md-nowrap flex-wrap gap-3">
                ...
                <a
                    href="{{ route('admin.team.packages.create') }}"class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
                ...
                <div class="ol-card-body mb-5 p-3">
                    <div class="row mb-4 mt-3">
                                ...
                                <ul class="dropdown-list">
                                    <li>
                                        <a class="dropdown-item export-btn" href="#"
                                            onclick="downloadPDF('.print-table', 'package-list')"><i
                        ...
                        <div class="col-md-6 col-lg-9 col-xl-6 mt-md-0 mt-3">
                            <form action="{{ route('admin.team.packages') }}"method="get">
                                <div class="row">
                                    <div class="col-9">
                                        <div class="row">
                                            ...
                                            <div class="search-input flex-grow-1">
                                                ...
                                                @if (request()->has('search'))
                                                    <div class="cancle-search-btn">
                                                        <a href="{{ route('admin.team.packages') }}">
                                    ...
                                    <table class="eTable eTable-2 print-table table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="print-d-none text-center">
                                                    {{ get_phrase('Options') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($packages as $key => $package)
                                                <tr>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="dAdmin_profile_img">
                                                                <img class="img-fluid rounded-circle image-45"
                                                                    width="40" height="40"
                                                                    src="{{ get_image($package->thumbnail) }}" />
                                                            </div>
                                                            <div class="ms-1 mt-1">
                                                                <h4 class="title fs-14px">
                                                                    <a
                                                                        href="{{ route('admin.team.packages.edit', $package->id) }}">
                                                    ...
                                                    <td class="print-d-none">
                                                        <span
                                                            class="badge bg-{{ $package->status ? 'active' : 'inactive' }}">{{ get_phrase($package->status ? 'Active' : 'Inactive') }}</span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="print-d-none text-center">
                                                        <div
                                                            class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent d-flex justify-content-center">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        onclick="confirmModal('{{ route('admin.team.packages.duplicate', $package->id) }}')"
                                                                        href="javascript:void(0)">{{ get_phrase('Duplicate') }}</a>
                                                                </li>
                                                                @if ($package->status)
                                                                    <li>
                                                                        <a class="dropdown-item"
                                                                            onclick="confirmModal('{{ route('admin.team.toggle.status', $package->id) }}')"
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        onclick="confirmModal('{{ route('admin.team.packages.delete', $package->id) }}')"
