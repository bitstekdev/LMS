        ...
        <div class="col-12">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="icon" value="{{ $category->icon }}"
                    class="form-control ol-form-control icon-picker" id="icon-picker"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="keywords" value="{{ $category->keywords }}"
                    class="form-control ol-form-control" id="Keywords"
            ...
            <div class="mb-3">
                <label for="category_logo" class="form-label ol-form-label">{{ get_phrase('Choose category Logo') }}
                    <small class="text-muted">({{ get_phrase('optional') }})</small></label>
