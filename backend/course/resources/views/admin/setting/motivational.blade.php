    ...
    <div class="row">
        <div class="col-md-8">
            <div id = "motivational_speech_area">
                @php
                    $motivational_speeches = get_frontend_json_setting('motivational_speech', [
                        ...
                        <div class="flex-grow-1 px-2 mb-3">
                            <div class="fpb-7 mb-3">
                                ...
                                <input type="text" class="form-control ol-form-control" name="titles[]"
                                    placeholder="{{ get_phrase('Title') }}" value="{{ $motivational_speech['title'] }}">
                            </div>
                            <div class="fpb-7 mb-3">
                                <label class="form-label ol-form-label">{{ get_phrase('designation') }}</label>
                                <input type="text" class="form-control ol-form-control" name="designation[]"
                                    placeholder="{{ get_phrase('designation') }}"
                                    value="{{ $motivational_speech['designation'] ?? '' }}">
                            </div>
                            <div class="fpb-7 mb-3">
                            ...
                            <div class="fpb-7 mb-3">
                                ...
                                <div class="custom-file">
                                    <input name="previous_images[]" type="hidden"
                                        value="{{ $motivational_speech['image'] }}">
                                    <input type="file" class="form-control ol-form-control" name="images[]"
