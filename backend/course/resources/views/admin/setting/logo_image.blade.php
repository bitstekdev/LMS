                ...
                <div class="col-xl-12">
                    <div class="row justify-content-center">
                        <form action="{{ route('admin.website.settings.update') }}" method="post"
                                        ...
                                        <div class="upload-options">
                                            @php
                                                ...
                                                if (
                                                    ...
                                                    $banner = json_decode(get_frontend_settings('banner_image'))
                                                        ->$banneractive;
                                            ...
                                            <input id="banner_image" type="file" class="image-upload d-none"
                            ...
                            <button type="submit"
                                class="btn ol-btn-primary w-100">{{ get_phrase('Save changes') }}</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <form action="{{ route('admin.website.settings.update') }}" method="post"
                            ...
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview  d-flex justify-content-center">
                                    <div class="box">
                                        <div class="upload-options">
                                            <img src="{{ asset(get_frontend_settings('light_logo')) }}" alt=""
                                                class="bg-dark radious-15px px-2 py-2">
                                            ...
                                            <input id="light_logo" type="file" class="image-upload d-none"
                                    ...
                                    <div class="box">
                                        <div class="upload-options">
                                            ...
                                            <label for="dark_logo" class="btn ol-card p-4-text">
                                                ...
                                                <small class="d-block">(330 X 70)</small> </label>
                                            <input id="dark_logo" type="file" class="image-upload d-none"
                    ...
                    <div class="row justify-content-center">
                        <form action="{{ route('admin.website.settings.update') }}" method="post"
                            ...
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview d-flex justify-content-center">
                                    <div class="box">
                                        <img width="100px" src="{{ asset(get_frontend_settings('favicon')) }}"
                                            alt="">
                                        <div class="upload-options">
                                            <label for="favicon" class="btn ol-card p-4-text">
                                                ...
                                                <br> <small>(90 X
                                                    90)</small> </label>
                                            <input id="favicon" type="file" class="image-upload d-none"
