@php
    $home_page_identifire = App\Models\BuilderPage::where('id', $id)->first()->identifier;
@endphp
                        ...
                        <div class="d-flex mt-2 border-top pt-2">
                            <div class="flex-grow-1 px-2 mb-3">
                                <div class="fpb-7 mb-3">
                                    ...
                                    <input type="text" class="form-control ol-form-control" name="title"
                                        value="{{ $instructor_speech->title ?? '' }}" placeholder="Enter a title"
                                        required>
                                </div>
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Description') }}</label>
                                    <textarea name="description" class="form-control ol-form-control" placeholder="{{ get_phrase('Description') }}"
                                        required>{{ $instructor_speech->description ?? '' }}</textarea>
                                </div>
                                <div class="fpb-7 mb-3">
                                    ...
                                    <input type="text" class="form-control ol-form-control" name="video_url"
                                        value="{{ $instructor_speech->video_url ?? '' }}"
                                        placeholder="enter a video url" required>
                                </div>
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Image') }}</label>
                                    <div class="custom-file">
                                        <input name="previous_image" type="hidden"
                                            value="{{ $instructor_speech->image ?? '' }}">
                                        <input type="file" class="form-control ol-form-control" name="image"
                                            value="{{ $instructor_speech->image ?? '' }}" accept="image/*">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    @elseif($home_page_identifire == 'university')
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="flex-grow-1 px-2 mb-3">
                                <div class="fpb-7 mb-3">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input type="file" class="form-control ol-form-control" name="image"
                                            value="{{ $university->image ?? '' }}" accept="image/*">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex mt-2 border-top pt-2">
                            <div class="flex-grow-1 px-2 mb-3">
                                <div class="fpb-7 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input name="previous_faq_image" type="hidden"
                                            value="{{ $university->faq_image ?? '' }}">
                                        <input type="file" class="form-control ol-form-control" name="faq_image"
                                            value="{{ $university->faq_image ?? '' }}" accept="image/*">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <button type="button" onclick="addSliderImageField()" class="btn ol-btn-primary"><i
                                class="fi-rr-plus-small"></i> {{ get_phrase('Add Image') }}</button>
                    </div>
                    <div class="col-6">
                        <button type="button" onclick="addSliderVideoField()" class="btn ol-btn-primary"><i
                                class="fi-rr-plus-small"></i> {{ get_phrase('Add Video Link') }}</button>
                    </div>
                </div>
                    ...
                    @foreach ($slider_items as $key => $slider_item)
                            ...
                            <div class="d-flex mt-2 border-top pt-2 align-items-center">
                                ...
                                <div class="flex-grow-1 px-2 mb-3">
                                    <div class="fpb-7 mb-3">
                                        <label class="form-label ol-form-label">{{ get_phrase('Image') }}</label>
                                        <div class="custom-file">
                                            <input type="hidden" value="{{ $slider_item }}"
                                                class="form-control ol-form-control" name="previous_slider_items[]">
                                            <input type="hidden" value="{{ $slider_item }}"
                                                class="form-control ol-form-control" name="slider_items[]">
                                            <input type="file" class="form-control ol-form-control"
                                                name="slider_items[]" accept="image/*">
                                        </div>
                                    </div>
                                </div>
                                <button class="btn btn-danger" onclick="$(this).parent().remove();"><i
                        ...
                        @else
                            <div class="d-flex mt-2 border-top pt-2 align-items-center">
                                <div class="flex-grow-1 px-2 mb-3">
                                    <div class="fpb-7 mb-3">
                                        <label class="form-label ol-form-label">{{ get_phrase('Video Link') }}
                                            <small>({{ get_phrase('Youtube') }} &
                                                {{ get_phrase('HTML5') }})</small></label>
                                        <div class="custom-file">
                                            <input type="hidden" value="{{ $slider_item }}"
                                                class="form-control ol-form-control" name="previous_slider_items[]">
                                            <input type="text" value="{{ $slider_item }}"
                                                class="form-control ol-form-control" name="slider_items[]">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="d-flex mt-2 border-top pt-2">
                            <div class="flex-grow-1 px-2 mb-3">
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Title') }}</label>
                                    <input type="text" class="form-control ol-form-control" name="title"
                                        value="{{ $development->title ?? '' }}" placeholder="Enter a title" required>
                                </div>
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Description') }}</label>
                                    <textarea name="description" class="form-control ol-form-control" placeholder="{{ get_phrase('Description') }}"
                                        required>{{ $development->description ?? '' }}</textarea>
                                </div>
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Image') }}</label>
                                    <div class="custom-file">
                                        ...
                                        <input type="file" class="form-control ol-form-control" name="image"
                                            value="{{ $development->image ?? '' }}" accept="image/*">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex mt-2 border-top pt-2">
                            <div class="flex-grow-1 px-2 mb-3">
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Title') }}</label>
                                    <input type="text" class="form-control ol-form-control" name="title"
                                        value="{{ $kindergarden->title ?? '' }}" placeholder="Enter a title"
                                        required>
                                </div>
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Description') }}</label>
                                    <textarea name="description" class="form-control ol-form-control" placeholder="{{ get_phrase('Description') }}"
                                        required>{{ $kindergarden->description ?? '' }}</textarea>
                                </div>
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Image') }}</label>
                                    <div class="custom-file">
                                        <input name="previous_image" type="hidden"
                                            value="{{ $kindergarden->image ?? '' }}">
                                        <input type="file" class="form-control ol-form-control" name="image"
                                            value="{{ $kindergarden->image ?? '' }}" accept="image/*">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    @elseif($home_page_identifire == 'marketplace')
                        ...
                        <div class="d-flex mt-2 border-top pt-2">
                            <div class="flex-grow-1 px-2 mb-3">
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Title') }}</label>
                                    <input type="text" class="form-control ol-form-control" name="title"
                                        value="{{ $instructor->title ?? '' }}" placeholder="Enter a title" required>
                                </div>
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Description') }}</label>
                                    <textarea name="description" class="form-control ol-form-control" placeholder="{{ get_phrase('Description') }}"
                                ...
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Video Url') }}</label>
                                    <input type="text" class="form-control ol-form-control" name="video_url"
                                        value="{{ $instructor->video_url ?? '' }}" placeholder="enter a video url"
                                        required>
                                </div>
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Image') }}</label>
                                    <div class="custom-file">
                                        ...
                                        <input type="file" class="form-control ol-form-control" name="image"
                                            value="{{ $instructor->image ?? '' }}" accept="image/*">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex-grow-1 px-2 mb-3">
                                <div class="fpb-7 mb-3">
                                    ...
                                    <input type="text" class="form-control ol-form-control"
                                        name="banner_title{{ $key }}"
                                        placeholder="{{ get_phrase('Title') }}"
                                        value="{{ $slider?->banner_title }}">
                                </div>
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Description') }}</label>
                                    <textarea name="banner_description{{ $key }}" class="form-control ol-form-control"
                                        placeholder="{{ get_phrase('Description') }}">{{ $slider?->banner_description }}</textarea>
                                </div>
                            ...
                            @if ($key == 0)
                                <div class="pt-4">
                                    <button type="button" class="btn ol-btn-light ol-icon-btn mt-2" name="button"
                                        ...
                                        onclick="appendMotivational_speech()"> <i class="fi-rr-plus-small"></i>
                                    </button>
                                </div>
                            @else
                                <div class="pt-4">
                                    <button type="button" class="btn ol-btn-light ol-icon-btn mt-2" name="button"
                                        ...
                                        onclick="removeMotivational_speech(this)">
                    ...
                    <div id = "blank_motivational_speech_fields">
                        <div class="d-flex mt-2 border-top pt-2">
                            <div class="flex-grow-1 px-2 mb-3">
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Title') }}</label>
                                    <input type="text" class="form-control ol-form-control" name="banner_title"
                                        placeholder="{{ get_phrase('Title') }}">
                                </div>
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Description') }}</label>
                                    <textarea name="banner_description" class="form-control ol-form-control"
        ...
        <script type="text/javascript">
            ...
            function appendMotivational_speech() {
                ...
                newMotivationalSpeech.find('textarea[name="banner_description"]').attr('name', 'banner_description' +
                    sliderCounter);
                    ...
                    <div class="d-flex mt-2 border-top pt-2">
                        <div class="flex-grow-1 px-2 mb-3">
                            <div class="fpb-7 mb-3">
                                ...
                                <div class="custom-file">
                                    <input type="hidden" class="form-control ol-form-control"
                                        name="big_previous_image" value="{{ $bigImage->big_image ?? '' }}">
                                    <input type="file" class="form-control ol-form-control" name="big_image"
                                        value="{{ $bigImage->big_image ?? '' }}" accept="image/*">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex mt-2">
                            ...
                            <div class="flex-grow-1 px-2 mb-3">
                                <div class="fpb-7 mb-3">
                                    ...
                                    <input type="text" class="form-control ol-form-control"
                                        name="banner_title{{ $key }}"
                                        placeholder="{{ get_phrase('Title') }}" value="{{ $slider->banner_title }}"
                                        required>
                                </div>
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Description') }}</label>
                                    <textarea name="banner_description{{ $key }}" class="form-control ol-form-control"
                                        placeholder="{{ get_phrase('Description') }}" required>{{ $slider->banner_description }}</textarea>
                                </div>
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Image') }}</label>
                                    <div class="custom-file">
                                        <input type="hidden" name="old_image{{ $key }}"
                                            value="{{ $slider->image ?? '' }}">
                                        <input type="file" class="form-control ol-form-control"
                                            name="image{{ $key }}" value="{{ $slider->image ?? '' }}"
                                            accept="image/*">
                                    </div>
                                </div>
                            ...
                            @if ($key == 0)
                                <div class="pt-4">
                                    <button type="button" class="btn ol-btn-light ol-icon-btn mt-2" name="button"
                                        data-bs-toggle="tooltip" title="{{ get_phrase('Add new') }}"
                                        onclick="append_speech()"> <i class="fi-rr-plus-small"></i>
                                    </button>
                                </div>
                            @else
                                <div class="pt-4">
                        ...
                        <div class="d-flex mt-2 border-top pt-2 w-100">
                            <div class="flex-grow-1 px-2 mb-3">
                                ...
                                <div class="fpb-7 mb-3">
                                    <label class="form-label ol-form-label">{{ get_phrase('Image') }}</label>
                                    <div class="custom-file">
                                        <input type="hidden" class="form-control ol-form-control" name="old_image"
                                            value="">
                                        <input type="file" class="form-control ol-form-control" name="image"
                                            value="" accept="image/*">
                                    </div>
    ...
    <div class="d-flex mt-2 border-top pt-2 align-items-center">
        <div class="flex-grow-1 px-2 mb-3">
            <div class="fpb-7 mb-3">
                <label class="form-label ol-form-label">{{ get_phrase('Image') }}</label>
                <div class="custom-file">
                    <input type="hidden" value="no" class="form-control ol-form-control"
                        name="previous_slider_items[]">
...
<div id="sliderBlankVideoField" class="d-none">
    <div class="d-flex mt-2 border-top pt-2 align-items-center">
        <div class="flex-grow-1 px-2 mb-3">
            <div class="fpb-7 mb-3">
                <label class="form-label ol-form-label">{{ get_phrase('Video Link') }}
                    <small>({{ get_phrase('Youtube') }} & {{ get_phrase('HTML5') }})</small></label>
                <div class="custom-file">
                    <input type="hidden" value="no" class="form-control ol-form-control"
                        name="previous_slider_items[]">
