        ...
        <tbody>
            @foreach ($notify_settings as $key => $notification_row)
                <tr>
                    ...
                    <td>
                        <a onclick="showRightModal('{{ route('modal', ['admin.setting.edit_email_template', 'id' => $notification_row->id]) }}', '{{ get_phrase('New user registration') }}')"
                            class="btn ol-btn-primary btn-rounded" href="javascript:void(0)" data-toggle="tooltip"
                            data-placement="top" title="{{ get_phrase('Edit email template') }}"
                            ...
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    ...
                                    fill="#fff" />
                                <path
                                    d="M17.3399 10.95C17.3199 10.95 17.2899 10.95 17.2699 10.95C14.1499 10.64 11.6399 8.27 11.1599 5.17C11.0999 4.76 11.3799 4.38 11.7899 4.31C12.1999 4.25 12.5799 4.53 12.6499 4.94C13.0299 7.36 14.9899 9.22 17.4299 9.46C17.8399 9.5 18.1399 9.87 18.0999 10.28C18.0499 10.66 17.7199 10.95 17.3399 10.95Z"
                                    fill="#fff" />
                                <path
