        ...
        <div class="col-md-6">
            <div class="ol-card p-4">
                ...
                <div class="ol-card-body certificate_builder_view" id="certificate_builder_view">
                    ...
                    <a class="btn ol-btn-primary mt-3"
                        href="{{ route('admin.certificate.builder') }}">{{ get_phrase('Build your certificate') }}</a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="ol-card p-4">
                ...
                <div class="ol-card-body">
                    <form action="{{ route('admin.certificate.update.template') }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group text-start mb-3">
                            <img class="my-2" height="200px" src="{{ get_image(get_settings('certificate_template')) }}"
                                alt="">
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label ol-form-label"
                                for="certificate_template">{{ get_phrase('Upload your certificate template') }}</label>
                            <input type="file" class="form-control" name="certificate_template"
                                id="certificate_template"rows="4">
                        </div>
