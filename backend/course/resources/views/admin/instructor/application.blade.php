                                ...
                                <tbody>
                                    @foreach ($pendings as $key => $pending)
                                        <tr class="gradeU">
                                            ...
                                            <td>
                                                <a href="{{ route('admin.instructor.application.download', ['id' => $pending->id]) }}"
                                                    data-bs-toggle="tooltip" title="{{ get_phrase('Download') }}"
                                ...
                                <tbody>
                                    @foreach ($approved as $key => $approve)
                                        <tr class="gradeU">
                                            ...
                                            <td>
                                                <a href="{{ route('admin.instructor.application.download', ['id' => $approve->id]) }}"
                                                    class="btn ol-btn-light ol-icon-btn"><span
