...
@section('content')
    ...
    <div class="ol-card p-4">
        ...
        <div class="ol-card-body">
            <form action="{{ route('admin.instructor.update', ['id' => $instructor->id]) }}" method="post"
                ...
                <div class="d-flex gap-3 flex-wrap flex-md-nowrap">
                    <div class="ol-sidebar-tab">
                        <div class="nav flex-column nav-pills" id="myv-pills-tab" role="tablist"
                            ...
                            <button class="nav-link text-start active" id="v-pills-tab1-tab" data-bs-toggle="pill"
                            ...
                            <button class="nav-link text-start" id="v-pills-tab2-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-tab2" type="button" role="tab" aria-controls="v-pills-tab2"
                                aria-selected="false">
                    ...
                    <div class="tab-content w-100" id="myv-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-tab1" role="tabpanel"
                            aria-labelledby="v-pills-tab1-tab" tabindex="0">
