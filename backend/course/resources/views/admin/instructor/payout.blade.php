                ...
                <div class="col-md-12">
                    <ul class="nav nav-tabs eNav-Tabs-custom eTab" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link @if (!isset($_GET['eDateRange'])) active @endif" id="cHome-tab"
                                data-bs-toggle="tab" data-bs-target="#cHome" type="button" role="tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link @if (isset($_GET['eDateRange'])) show active @endif" id="cProfile-tab"
                                data-bs-toggle="tab" data-bs-target="#cProfile" type="button" role="tab"
                    ...
                    <div class="tab-content eNav-Tabs-content" id="myTabContent">
                        <div class="tab-pane fade @if (!isset($_GET['eDateRange'])) show active @endif" id="cHome"
                            role="tabpanel" aria-labelledby="cHome-tab">
                            <div class="row print-d-none mt-4 row-gap-3">
                                ...
                                <div class="col-md-6">
                                    <form class="form-inline" action="{{ route('admin.instructor.payout.filter') }}"
                                        method="get">
                                        <div class="row mb-4">
                                            <div class="col-md-9">
                                            ...
                                            @foreach ($instructor_payout_incomplete as $key => $instructor_payout_incompleted)
                                                <tr>
                                                        ...
                                                        <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                                            <div class="dAdmin_profile_img">
                                                                <img class="img-fluid rounded-circle image-45"
                                                                    width="45" height="45"
                                                                    src="{{ get_image_by_id($instructor_payout_incompleted->user_id) }}" />
                                                            </div>
                                                            <div class="ms-1">
                                                                <h4 class="title fs-14px">
                                                                    {{ get_user_info($instructor_payout_incompleted->user_id)->name }}
                                                                </h4>
                                                                <p class="sub-title2 text-12px">
                                                                    {{ get_user_info($instructor_payout_incompleted->user_id)->email }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="print-d-none">
                                                        <form action="{{ route('admin.instructor.payment') }}"
                                                            method="post">
                                                            @csrf
                                                            <input type="hidden" name="user_id"
                                                                value="{{ $instructor_payout_incompleted->user_id }}">
                                                            <input type="hidden" name="amount"
                                                                value="{{ $instructor_payout_incompleted->amount }}">
                                                            <input type="hidden" name="payout_id"
                                                                value="{{ $instructor_payout_incompleted->id }}">
                        ...
                        <div class="tab-pane fade @if (isset($_GET['eDateRange'])) show active @endif" id="cProfile"
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-3">
                                                <button type="submit" class="btn ol-btn-primary w-100"
                                                    id="submit-button" onclick="update_date_range();">
                                                    {{ get_phrase('Filter') }}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                                    ...
                                                    <td>
                                                        <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                                            <div class="dAdmin_profile_img">
                                                                <img class="img-fluid rounded-circle image-45"
                                                                    width="45" height="45"
                                                                    src="{{ get_image_by_id($instructor_payouts->user_id) }}" />
                                                            </div>
                                                            <div class="ms-1">
                                                                <h4 class="title fs-14px">
                                                                    {{ get_user_info($instructor_payouts->user_id)->name }}
                                                                </h4>
                                                                <p class="sub-title2 text-12px">
                                                                    {{ get_user_info($instructor_payouts->user_id)->email }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
