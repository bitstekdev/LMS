                    ...
                    <form action="{{ route('admin.instructor.setting.store') }}" method="post"
                        ...
                        <div class="fpb-7 mb-3">
                            ...
                            <select class="form-control ol-form-control ol-select2" data-toggle="select2"
                                name="allow_instructor" required>
                        ...
                        <div class="fpb-7 mb-3">
                            <label class="form-label ol-form-label"
                                for="instructor_application_note">{{ get_phrase('Instructor application note') }}</label>
            ...
            <div class="ol-card p-4">
                ...
                <div class="ol-card-body">
                    <form action="{{ route('admin.instructor.setting.store') }}" method="post"
                        ...
                        <div class="fpb-7 mb-3">
                            <label class="form-label ol-form-label"
                                for="instructor_revenue">{{ get_phrase('Instructor revenue percentage') }}</label>
                            <div class="input-group">
                                <input type="number" name = "instructor_revenue" id = "instructor_revenue"
                                    class="form-control ol-form-control" onkeyup="calculateAdminRevenue(this.value)"
                                    min="0" max="100" value="{{ $instructor_revenue->description }}">
                        ...
                        <div class="fpb-7 mb-3">
                            <label class="form-label ol-form-label"
                                for="admin_revenue">{{ get_phrase('Admin revenue percentage') }}</label>
                            <div class="input-group">
                                <input type="number" name = "admin_revenue" id = "admin_revenue"
                                    class="form-control ol-form-control" value="0" disabled>
                                <div class="input-group-append">
                                    <span class="input-group-text ol-form-control">%</span>
                                </div>
                            </div>
