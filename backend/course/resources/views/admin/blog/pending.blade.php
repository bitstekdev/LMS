                                ...
                                <ul class="dropdown-list">
                                    <li>
                                        <a class="dropdown-item" href="#"
                                            onclick="downloadPDF('.print-table', 'pending-blogs')"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                                    <div class="dAdmin_profile_img">
                                                        <img class="img-fluid rounded-circle image-45" width="40"
                                                            height="40" src="{{ get_image($blog->user->photo) }}" />
                                                    </div>
                                                    <div class="ms-1 mt-1">
                                            ...
                                            <td>
                                                <div class="dAdmin_info_name min-w-150px">
                                                    <p><a
                                                            href="{{ route('blog.details', slugify($blog->title)) }}">{{ $blog->title }}</a>
                                                    </p>
                                                    <small
                                                        class="text-muted">{{ date('D, d-M-Y', strtotime($blog->created_at)) }}</small>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dAdmin_info_name min-w-150px">
                                                    <p><span
                                                            class="badge {{ $blog->status ? 'bg-success' : 'bg-danger' }} text-white">{{ get_phrase($blog->status ? 'Active' : 'Inactive') }}</span>
                                                    </p>
                                                </div>
                                            </td>
                                                ...
                                                <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('admin.blog.edit', ['id' => $blog->id]) }}">{{ get_phrase('Edit') }}</a>
                                                        </li>
                                                        <li><a class="dropdown-item" href="#"
                                                                onclick="confirmModal('{{ route('admin.blog.status', $blog->id) }}')">{{ get_phrase($blog->status ? 'Inactive' : 'Activate') }}</a>
                                                        </li>
                                                        <li><a class="dropdown-item" href="#"
                                                                onclick="confirmModal('{{ route('admin.blog.delete', $blog->id) }}')">{{ get_phrase('Delete') }}</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
