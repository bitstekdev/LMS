                                ...
                                <ul class="dropdown-list">
                                    <li>
                                        <a class="dropdown-item" href="#"
                                            onclick="downloadPDF('.print-table', 'contacts')"><i class="fi-rr-file-pdf"></i>
                                            {{ get_phrase('PDF') }}</a>
                                    </li>
                                    <li>
                                    ...
                                    <div class="col-md-9">
                                        <div class="search-input">
                                            <input type="text" name="search" value="{{ request('search') }}"
                                                placeholder="{{ get_phrase('Search Contact') }}"
                                                    ...
                                                    <div class="dAdmin_profile_name">
                                                        ...
                                                        <p>
                                                            @if (!check_registered($contact->email))
                                                                <span
                                                                    class="badge bg-danger">{{ get_phrase('Not registered') }}</span>
                                                            @else
                                                                <span
                                                                    class="badge bg-success">{{ get_phrase('Registered') }}</span>
                                                            @endif
                                                        </p>
                                                    </div>
                                                </div>
