                        ...
                        <ul class="dropdown-list">
                            <li>
                                <a class="dropdown-item" href="#"
                                    onclick="downloadPDF('.print-table', 'admin-list')"><i class="fi-rr-file-pdf"></i>
                                    {{ get_phrase('PDF') }}</a>
                            </li>
                            <li>
                                                ...
                                                @if (!is_root_admin($row->id))
                                                    <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.admins.edit', ['id' => $row->id]) }}">{{ get_phrase('Edit') }}</a>
                                                            </li>

                                                            <li>
                                                                <a class="dropdown-item"
                                                                    onclick="confirmModal('{{ route('admin.admins.delete', $row->id) }}')"
