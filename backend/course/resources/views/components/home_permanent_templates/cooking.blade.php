...
@section('content')
            ...
            <div class="row row-28">
                <div class="col-lg-6 order-2 order-lg-1">
                    ...
                    <div class="cooking-banner-details">
                        ...
                        <h1 class="title mb-20"><span class="highlight">{{ $first_word }}</span> <span
                                class="small">{{ $second_word }} {{ $remaining_text }}</span></h1>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a class="rectangle-btn2 ms-5 theme-text-color" data-bs-toggle="modal"
                                data-bs-target="#promoVideo" href="#"><i class="ms-4 me-3 fa-solid fa-play"></i>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="cooking-section-title">
                        <h3 class="title-5 fs-32px lh-42px fw-600 text-center mb-20">{{ get_phrase('Top Rated Courses') }}
                        </h3>
                        <p class="info">
                                ...
                                <div class="cooking-course-card-body">
                                    ...
                                    <div class="time-rating d-flex align-items-center justify-content-between flex-wrap">
                                        <div class="time-wrap d-flex align-items-center">
                                            <img src="{{ asset('assets/frontend/default/image/clock-gray-20.svg') }}"
                                                alt="">
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="cooking-section-title">
                        <h3 class="title-5 fs-32px lh-42px fw-600 text-center mb-20">{{ get_phrase('Upcoming Courses') }}
                        </h3>
                        <p class="info">
                                    ...
                                    <div class="date-time-price">
                                        <div>
                                            ...
                                            @if (isset($row->discount_flag) && $row->discount_flag == 1)
                                                <p class="value">{{ currency($row->price - $row->discounted_price, 2) }}
                                                </p>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="cooking-section-title">
                        <h3 class="title-5 fs-32px lh-42px fw-600 text-center mb-20">{{ get_phrase('Featured Courses') }}
                        </h3>
                        <p class="info">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title-2 mb-50px">
                        <h1 class="title-5 fs-32px lh-42px fw-600 mb-20px text-center">
                                ...
                                <div class="event-details-banner-wrap w-100 d-flex">
                                    ...
                                    <div class="lms-event1-banner">
                                        @if ($motivational_speech['image'])
                                            <img class="rounded-0" src="{{ get_image($motivational_speech['image']) }}"
                                                alt="">
                                        @else
                                        @endif
                                    </div>
        ...
        <div class="container pt-5">
            <div class="row g-20px mb-100px align-items-center">
                <div class="col-xl-5 col-lg-6 order-2 order-lg-1">
                    <div class="">
                        <h1 class="title-5 fs-32px lh-42px fw-600 mb-20px">
    ...
    @if ($instructor_speech = json_decode(get_homepage_settings('cooking')))
                        ...
                        <div class="become-instructor-area d-flex align-items-center justify-content-between">
                            <div class="become-instructor-video-area">
                                @if (isset($instructor_speech->image))
                                    <img src="{{ asset('uploads/home_page_image/cooking/' . $instructor_speech->image) }}"
                                        alt="">
                                @else
                                @endif
                                <a href="javascript:void(0);" class="play-icon" type="button" class="btn btn-primary"
                                    data-bs-toggle="modal" data-bs-target="#becomeInstructor">
                                    <img src="{{ asset('assets/frontend/default/image/play-white-large.svg') }}"
                                        alt="">
                                </a>
                            </div>
        ...
        <div class="modal fade instructor-video-modal" id="becomeInstructor" tabindex="-1"
            aria-labelledby="becomeInstructorLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="instructor-modal-video">
                            <div class="plyr__video-embed" id="becomeInstructorPlyr">
                                <iframe src="{{ $instructor_speech->video_url }}" title="YouTube video player"
                                    frameborder="0"
                ...
                <div class="col-md-12">
                    <div class="cooking-section-title">
                        <h3 class="title-5 fs-32px lh-42px fw-600 text-center mb-20">
                            {{ get_phrase('Our Popular Instructor') }}</h3>
                        <p class="info">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="cooking-popular-instructor">
                            ...
                            <div class="details">
                                ...
                                <ul
                                    class="popular-instructor-socila d-flex align-items-center justify-content-center flex-wrap">
                                    <li>
                                        <a href="{{ $instructorDetails->facebook }}">
                                            <svg width="8" height="15" viewBox="0 0 8 15" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <mask id="mask0_111_1949" style="mask-type:luminance"
                                                    maskUnits="userSpaceOnUse" x="0" y="0" width="8" height="15">
                                                    <path d="M7.53321 0.875488H0V14.812H7.53321V0.875488Z"
                                                        fill="white" />
                                                </mask>
