                ...
                <div class="row gy-4 mb-80px align-items-center">
                    <div class="col-lg-6 order-2 order-lg-1">
                        <div>
                            ...
                            <h1 class="title-3 fs-48px lh-normal fw-medium mb-20px kg-banner-title">{{ $phrase_one }}
                                <span class="title-purple fw-semibold kg-banner-title-last">{{ $phrase_two }}</span>
                            </h1>
                            <p class="speech-purple-bordered subtitle-2 fs-16px lh-24px mb-30px">
                                {{ get_frontend_settings('banner_sub_title') }}</p>
                            <div class="d-flex align-items-center gap-4 mb-3 flex-wrap">
                                <a href="{{ route('courses') }}"
                                    class="btn btn-purple-1 btn-purple-sm d-flex align-items-center gap-2">
                                    <span>{{ get_phrase('Explore Courses') }}</span>
                                    <span class="fi-rr-arrow-right"></span>
                                </a>
                                <a href="javascript:void(0);" class="play-btn-1" type="button" data-bs-toggle="modal"
                                    data-bs-target="#promoVideo">
                                    <span class="icon"><img
                                            src="{{ asset('assets/frontend/default/image/play-white-12.svg') }}"
                                            alt=""></span>
                                    <span>{{ get_phrase('Watch Video') }}</span>
                                </a>
                            </div>
                            <ul
                                class="cooking-banner-sponsors owl-carousel owl-theme cook_slider d-flex align-items-center flex-wrap">
                                <li>
                                    <div class="item">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2">
                        <div class="lms-banner-2 px-md-4">
                            @php
                                ...
                                if (
                                    $bannerData !== null &&
                                    is_object($bannerData) &&
                                    property_exists($bannerData, $banneractive)
                                ) {
                ...
                <div class="row g-28px row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-1">
                    <div class="col">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h2 class="kg-counter-title mb-2px"><span
                                        class="counter2">{{ count($premium_courses) }}</span>+</h2>
                    ...
                    <div class="col">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h2 class="kg-counter-title mb-2px"><span
                                        class="counter2">{{ count($total_instructors) }}</span>+</h2>
                    ...
                    <div class="col">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h2 class="kg-counter-title mb-2px"><span
                                        class="counter2">{{ count($total_students) }}</span>+</h2>
                    ...
                    <div class="col">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h2 class="kg-counter-title mb-2px"><span
                                        class="counter2">{{ count($free_courses) }}</span>+</h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title-1 mb-50px">
                        <h1 class="title-3 mb-20px fs-40px lh-52px fw-medium text-center">{{ get_phrase('Top Courses') }}
                        </h1>
                ...
                @php
                    $top_courses = DB::table('courses')
                        ...
                        ->select(
                            ...
                            'courses.is_paid',
                            'courses.price',
                            'courses.discounted_price',
                            DB::raw('COUNT(payment_histories.id) as total_sales'),
                        )
                        ->groupBy(
                            'courses.id',
                            'courses.slug',
                            ...
                            <div class="lms-1-card rounded-4 rounded-4 lms-card-hover1">
                                <div class="lms-1-card-body">
                                    ...
                                    <div class="course-card1-details">
                                        <h5 class="title-3 fs-18px lh-26px fw-medium mb-10px ellipsis-line-2">
                                            {{ ucfirst($row->title) }}</h5>
                                        <div
                                            class="card-leason-rating1 d-flex gap-2 align-items-center justify-content-between">
                                            <div class="card-icon-text1 d-flex gap-2 align-items-center">
                                                <span class="fi-rr-book-open-cover"></span>
                                                <p class="info">{{ lesson_count($row->id) }}
                                                    {{ get_phrase('lessons') }}</p>
                                            </div>
                                        ...
                                        <div
                                            class="kg-card-profile-price d-flex align-items-center justify-content-between flex-wrap gap-2">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="card-author-sm">
                                                    <img src="{{ course_instructor_image($row->id) }}" alt="">
                                                </div>
                                                <div class="title-1 fs-13px lh-26px fw-bold">
                                                    {{ course_by_instructor($row->id)->name }}</div>
                                            </div>

                                            @if (isset($row->is_paid) && $row->is_paid == 0)
                                                <h4 class="price title-1 fs-20px lh-26px fw-bold">{{ get_phrase('Free') }}
                                                </h4>
                                ...
                                <div class="lms-1-card-body">
                                    <div class="d-flex align-items-center gap-20px">
                                        ...
                                        <div>
                                            ...
                                            <p class="subtitle-2 fs-16px lh-23px fw-medium">
                                                {{ count_category_courses($category->id) }} {{ get_phrase('courses') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title-1 mb-50px">
                        <h1 class="title-3 mb-20px fs-40px lh-52px fw-medium text-center">
                            {{ get_phrase('Featured Courses') }}</h1>
                        <p class="subtitle-2 fs-16px lh-24px text-center">
                            {{ get_phrase('Awesome  site. on the top advertising a business online includes assembling Having the most keep.') }}
                        </p>
                    </div>
                        ...
                        <a href="{{ route('course.details', $row->slug) }}" class="d-block h-100 w-100 max-sm-350px">
                            <div class="lms-1-card rounded-4 lms-card-hover1">
                                <div class="lms-1-card-body">
                                    ...
                                    <div class="course-card1-details">
                                        <h5 class="title-3 fs-18px lh-26px fw-medium ellipsis-line-2 mb-10px">
                                            {{ ucfirst($row->title) }}</h5>
                                        <div
                                            class="card-leason-rating1 d-flex gap-2 align-items-center justify-content-between">
                                            <div class="card-icon-text1 d-flex gap-2 align-items-center">
                                                <span class="fi-rr-book-open-cover"></span>
                                                <p class="info">{{ lesson_count($row->id) }} {{ get_phrase('lesson') }}
                                                </p>
                                            </div>
                                            <div class="card-rating1 d-flex gap-1 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="community-banner1">
                            @if (isset($stordetails->image))
                                <img src="{{ asset('uploads/home_page_image/kindergarden/' . $stordetails->image) }}"
                                    alt="">
                            @else
                                <img src="{{ asset('assets/frontend/default/image/community-banner.webp') }}"
                                    alt="">
                            @endif
                        </div>
                    </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button {{ $key == 0 ? '' : 'collapsed' }}"
                                            ...
                                            data-bs-target="#collapseLeft{{ $key }}" aria-expanded="true"
                                            aria-controls="collapseLeft{{ $key }}">
                                            {{ $faq['question'] }}
                                        </button>
                                    </h2>
                                    <div id="collapseLeft{{ $key }}"
                                        class="accordion-collapse px-0 collapse {{ $key == 0 ? 'show' : '' }}"
                            ...
                            @foreach ($even_faqs as $key => $faq)
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button {{ $key == 0 ? '' : 'collapsed' }}"
                                            type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapseRight{{ $key }}" aria-expanded="true"
                                            aria-controls="collapseRight{{ $key }}">
                                            {{ $faq['question'] }}
                                        </button>
                                    </h2>
                                    <div id="collapseRight{{ $key }}"
                                        class="accordion-collapse px-0 collapse {{ $key == 0 ? 'show' : '' }}"
            ...
            <div class="row gx-0 gy-4 align-items-end mb-50px">
                <div class="col-xl-4">
                    <div class="lg-testimonial-titles mb-50px">
                        <h1 class="title-3 fs-40px lh-52px fw-medium mb-30px text-xl-start text-center">
                            {{ get_phrase('What they’re saying about our courses') }}</h1>
                                ...
                                <div class="swiper-slide">
                                    <div class="lms-single-testimonial1">
                                        <div class="single-testimonial1-inner" style="--bg-color: {{ $bgColor }}">
                                            ...
                                            <h4 class="title-3 fs-20px lh-25px fw-normal mb-10px">{{ $userDetails->name }}
                                            </h4>
