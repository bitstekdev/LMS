                ...
                <div class="col-md-12">
                    <div class="lms-banner-area-4">
                        <div class="uv-banner-content">
                            <h1 class="title-5 max-w-850px fs-56px lh-normal fw-500 text-white text-center mb-20px"><span
                                    class="highlight-title">{{ get_frontend_settings('banner_title') }}</span></h1>
                            <p class="subtitle-5 max-w-620px fs-15px lh-24px text-white text-center mb-30px">
