...
@section('content')
    ...
    <section>
        <div class="container">
            <div class="row mb-50px">
                <div class="col-md-12">
                    <div class="lms-banner-area-3"
                        style="background-image: url({{ isset($banner) ? $banner : $defaultBanner }});">
                        <!-- Swiper -->
                                    ...
                                    @foreach ($sliders as $key => $slider)
                                        <div class="swiper-slide">
                                            <div class="lms-banner-slide">
                                                ...
                                                <h1
                                                    class="title-4 fs-56px lh-normal fw-bold text-white text-center mb-50px">
                                                    {{ $slider->banner_description }}</h1>
                ...
                @foreach (App\Models\Category::take(5)->get() as $category)
                    <div class="col">
                        <a href="{{ route('courses', $category->slug) }}">
                            ...
                            <p class="subtitle-4 fs-15px lh-23px">{{ count_category_courses($category->id) }}
                                {{ get_phrase('courses') }}</p>
                        </a>
                    </div>
                @endforeach
            </div>
                            ...
                            <div class="lms-1-card rounded-4 lms-card-hover2">
                                <div class="lms-1-card-body p-0">
                                    <div class="grid-view-banner2 position-relative">
                                        <img class="h-190px radious-0" src="{{ get_image($row->thumbnail) }}"
                                            alt="">
                                    </div>
                                    <div class="p-4">
                                        <div class="mb-6px d-flex gap-2 align-items-center justify-content-between">
                                            <div class="card-icon-text2 d-flex gap-2 align-items-center">
                                                ...
                                                <p class="subtitle-4 fs-13px lh-26px">{{ lesson_count($row->id) }}
                                        ...
                                        <h5 class="title-4 fs-18px lh-26px fw-semibold my-4 ellipsis-line-2">
                ...
                <div class="col-md-12">
                    ...
                    <div class="counter-area-wrap2">
                        <div class="counter-single-item2">
                            <h1 class="title-4 fs-82px lh-107px fw-semibold text-white text-center mb-5px"><span
                                    class="counter2">{{ count($total_students) }}</span>+</h1>
                            <p class="subtitle-3 fs-18px lh-25px fw-normal text-white text-center">
                                {{ get_phrase('Happy Student') }}</p>
                        </div>
                        <div class="counter-single-item2">
                            <h1 class="title-4 fs-82px lh-107px fw-semibold text-white text-center mb-5px"><span
                                    class="counter2">{{ count($total_instructors) }}</span></h1>
                            <p class="subtitle-3 fs-18px lh-25px fw-normal text-white text-center">
                                {{ get_phrase('Quality educators') }}+</p>
                        </div>
                        <div class="counter-single-item2">
                            <h1 class="title-4 fs-82px lh-107px fw-semibold text-white text-center mb-5px"><span
                                    class="counter2">{{ count($premium_courses) }}</span>+</h1>
                            <p class="subtitle-3 fs-18px lh-25px fw-normal text-white text-center">
                                {{ get_phrase('Premium courses') }}</p>
                        </div>
                        <div class="counter-single-item2">
                            <h1 class="title-4 fs-82px lh-107px fw-semibold text-white text-center mb-5px"><span
                                    class="counter2">{{ count($free_courses) }}</span>+</h1>
                            <p class="subtitle-3 fs-18px lh-25px fw-normal text-white text-center">
                                {{ get_phrase('Cost-free course') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="video-banner-area1">
                            @if (isset($instructor->image))
                                <img src="{{ asset('uploads/home_page_image/marketplace/' . $instructor->image) }}"
                                    alt="">
                                <a href="javascript:void(0);" class="play-btn-2" type="button" class="btn btn-primary"
                                    data-bs-toggle="modal" data-bs-target="#becomeInstructor">
                                    <img src="{{ asset('assets/frontend/default/image/play-white-22.svg') }}"
                                        alt="">
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="modal-body">
                        <div class="instructor-modal-video">
                            <div class="plyr__video-embed" id="becomeInstructorPlyr">
                                <iframe src="{{ $instructor->video_url }}" title="YouTube video player" frameborder="0"
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="title-4 fs-34px lh-44px fw-semibold text-center mb-50px">
                                        ...
                                        <div class="lms-single-testimonial2">
                                            <div class="d-flex justify-content-between gap-2 mb-14px">
                                                <div class="testimonial-profile-wrap2 d-flex align-items-center ">
                                                    ...
                                                    <div>
                                                        <h4 class="title-4 fs-18px lh-25px fw-semibold mb-5px">
                                                            {{ $userDetails->name }}</h4>
                                                        <p class="subtitle-4 fs-14px lh-24px">
