...
@section('content')
                ...
                <div class="col-md-12">
                    ...
                    <div class="maditation-banner-content mb-80 d-flex">
                        ...
                        <div class="maditation-banner-image">
                            ...
                            @else
                                <img src="{{ asset('assets/frontend/default/image/maditation-banner.svg') }}"
                                    alt="">
                            @endif
                        </div>
                            ...
                            <div class="single-posesjourney-yoga">
                                ...
                                @php
                                    $backgroundImage = asset(
                                        'assets/frontend/default/image/pose-journey-shadow' . (($key % 3) + 1) . '.svg',
                                    );
                                @endphp
                        ...
                        <div class="yoga-benefits-wrap d-flex align-items-center">
                                    ...
                                    @if ($key % 2 == 0)
                                        <li>
                                            ...
                                            <div class="yoga-benefit-image">
                                                <img src="{{ asset('uploads/home_page_image/meditation/' . $slider->image ?? '') }}"
                                                    alt="">
                                            </div>
                                        </li>
                                    @endif
                            ...
                            <div class="yoga-benefit-banner">
                                @if (isset($bigImage->big_image))
                                    <img src="{{ asset('uploads/home_page_image/meditation/' . $bigImage->big_image) }}"
                                        alt="">
                                @endif
                            </div>
    ...
    <section
        style="background-color: background: rgba(255, 248, 246, 1);background-color: rgba(255, 248, 246, 1); padding-top: 60px; padding-bottom: 1px; margin-bottom: 50px;">
        <div class="container">
            <!-- Section title -->
            <div class="row">
                <div class="col-md-12">
