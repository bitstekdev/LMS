...
@section('content')
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-6">
                        ...
                        <div class="lms-banner-content-1">
                            ...
                            <h1 class="title-1 fs-44px lh-60px mb-14px fw-600">{{ $first_word }} <span
                                    class="italic-1 fw-semibold">{{ $second_word }}</span> {{ $remaining_text }}
                            </h1>
                            ...
                            <form action="{{ route('courses') }}" method="get">
                                <div class="lms-subscribe-form-1 d-flex gap-2 align-items-center flex-wrap">
                                    <input type="text" name="search" class="form-control form-control-1"
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="lms-banner-area-1 d-flex flex-sm-row flex-column">
                            <div class="lms-banner-1">
                                ...
                                @else
                                    <img src="{{ asset('assets/frontend/default/image/language-banner.webp') }}"
                                        alt="">
                                @endif
                            </div>
                            <div class="mt-auto mb-30px lms-banner-items1">
                                <div class="mb-40px">
                                    ...
                                    <p class="subtitle-1 fs-16px lh-24px">
                                        {{ get_phrase('User already register and signing up for using it') }}</p>
                                </div>
                                <div>
                                    <h2 class="title-1 fs-44px lh-60px fw-semibold mb-1">{{ count($total_instructors) }}+
                                    </h2>
                                    <p class="subtitle-1 fs-16px lh-24px">
                                        {{ get_phrase('Online Instructor have a new ideas every week.') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4 mb-100px">
                <div class="col-lg-4 col-md-6">
                    <div class="lms-service-card-1">
                        <img class="service-card-icon1" src="{{ asset('assets/frontend/default/image/bulb-blue-75.svg') }}"
                            alt="">
                        <h5 class="title-2 fs-18px lh-28px fw-semibold text-center mb-12">
                            {{ get_phrase('Latest Top Skills') }}</h5>
                        <p class="subtitle-1 fs-16px lh-24px text-center">
                            {{ get_phrase('Awesome  site the top advertising been business.') }}</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="lms-service-card-1">
                        <img class="service-card-icon1"
                            src="{{ asset('assets/frontend/default/image/peoples-star-blue-76.svg') }}" alt="">
                        <h5 class="title-2 fs-18px lh-28px fw-semibold text-center mb-12">
                            {{ get_phrase('Industry Experts ') }}</h5>
                        <p class="subtitle-1 fs-16px lh-24px text-center">
                            {{ get_phrase('Awesome  site the top advertising been business.') }}</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="lms-service-card-1">
                        <img class="service-card-icon1"
                            src="{{ asset('assets/frontend/default/image/world-blue-69.svg') }}" alt="">
                        <h5 class="title-2 fs-18px lh-28px fw-semibold text-center mb-12">
                            {{ get_phrase('Learning From Anywhere') }}</h5>
                        <p class="subtitle-1 fs-16px lh-24px text-center">
                            {{ get_phrase('Awesome  site the top advertising been business.') }}</p>
                    </div>
                </div>
                                ...
                                <div class="lms-1-card-body">
                                    <div class="d-flex gap-3 align-items-center flex-sm-row flex-column">
                                        ...
                                        <div class="list-view-details1 w-100">
                                            <h5
                                                class="title-1 fs-20px lh-28px fw-semibold mb-6px title-1 fs-20px lh-28px fw-semibold mb-6px ellipsis-line-2">
                                            ...
                                            <div class="card-rating-reviews1 mb-20 d-flex align-items-center flex-wrap">
                                                @php
                                                    $ratings = DB::table('reviews')
                                                        ...
                                                        ->toArray();
                                                    $average_rating =
                                                        count($ratings) > 0 ? array_sum($ratings) / count($ratings) : 0;
                                                ...
                                                @if ($review_count > 0)
                                                    ...
                                                    <p class="subtitle-1 fs-14px lh-20px">({{ $review_count }}
                                            ...
                                            <div class="card-programs-1 mb-20 d-flex align-items-center gap-2">
                                                ...
                                                <p class="subtitle-1 fs-14px lh-20px">{{ lesson_count($row->id) }}
                                                    {{ get_phrase('lesson') }}</p>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div class="title-1 fs-14px fw-medium">
                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-center mt-5">
                        <a href="{{ route('courses') }}"
                            class="btn btn-outline-primary-1">{{ get_phrase('View More') }}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-20px mb-100px align-items-center">
                <div class="col-xl-5 col-lg-6 order-2 order-lg-1">
                    <div>
                        ...
                        <h1 class="title-1 fs-32px lh-38px mb-20px">
                            {{ get_phrase('Know About Academy LMS Learning Platform') }}</h1>
            ...
            <div class="row g-20px mb-100px align-items-center">
                ...
                <div class="col-lg-6">
                    <div>
                        ...
                        <h1 class="title-1 fs-32px lh-38px mb-20px">
                            {{ get_phrase('Free Resources Learning English for Beginner') }}</h1>
                        ...
                        <div class="d-flex justify-content-center gap-20px flex-wrap flex-sm-nowrap">
                            <div class="bgcolor-card-1 bg-color-ffeff8-f6f0f4">
                                <h2 class="title-1 fs-44px lh-60px fw-semibold mb-1">{{ count($total_students) }}+</h2>
                                <p class="title-1 fs-16px lh-24px fw-normal">
                                    {{ get_phrase('User already register and signing up for using it') }}</p>
                            </div>
                            <div class="bgcolor-card-1 bg-color-e8f7fc-f1f9fc">
                                ...
                                <p class="title-1 fs-16px lh-24px fw-normal">
                                    {{ get_phrase('Instructor have a new ideas every week.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="lms-1-card max-sm-350px">
                            <div class="lms-1-card-body p-12px">
                                <div class="grid-view-banner1 mb-12px">
                                    <a
                                        href="{{ route('instructor.details', ['name' => slugify($instructorDetails->name), 'id' => $instructorDetails->id]) }}">
                                ...
                                <div>
                                    <div class="d-flex justify-content-between gap-1">
                                        <a
                                            href="{{ route('instructor.details', ['name' => slugify($instructorDetails->name), 'id' => $instructorDetails->id]) }}">
                                            <h5 class="title-1 fs-16px lh-24px fw-semibold mb-1">
                                                {{ $instructorDetails->name }}</h5>
                                            <p class="subtitle-1 fs-14px lh-20px">{{ get_phrase('Instructor') }}</p>
                                        </a>
                                        <div class="d-flex gap-1">
                                            <a href="{{ $instructorDetails->facebook }}" class="social-link-1">
                                                <img src="{{ asset('assets/frontend/default/image/lg-facebook.svg ') }}"
                                                    alt="">
                                            </a>
                                            <a href="{{ $instructorDetails->twitter }}" class="social-link-1">
                                                <img src="{{ asset('assets/frontend/default/image/lg-twiter.svg') }}"
                                                    alt="">
                                            </a>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="title-1 fs-32px lh-36px text-center mb-30">
                            ...
                            @foreach ($reviews as $review)
                                ...
                                <div class="single-testimonial-details1">
                                    <h2 class="title-1 fs-20px lh-28px fw-semibold mb-12px text-center">
                                        {{ $userDetails->name }}</h2>
                                    <div
                                        class="testimonial-ratings-1 mb-2 d-flex align-items-center justify-content-center">
                                        @for ($i = 1; $i <= 5; $i++)
                                            @if ($i <= $review->rating)
                                                <img src="{{ asset('assets/frontend/default/image/star-yellow-14.svg') }}"
                                                    alt="">
