            ...
            <div class="col-lg-12">
                <div class="res-control d-flex align-items-center justify-content-between">
                    <div class="section-title mb-0">
                        <span class="title-head mb-10 builder-editable"
                            builder-identity="1">{{ get_phrase('Our Blog') }}</span>
                        <h2 class="title builder-editable" builder-identity="2">
                            {{ get_phrase('Have a look on our news') }}</h2>
                    </div>
                    <span class="blog-view-all-button">
                        <a href="{{ route('blogs') }}" class="eBtn gradient builder-editable"
                            builder-identity="3">{{ get_phrase('View All Blogs') }}</a>
                    </span>
                </div>
            </div>
        </div>
