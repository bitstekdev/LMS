                ...
                <div class="header-menu d-flex justify-content-end me-lg-auto ms-lg-0 ms-auto mt-2 pt-1">
                    <div class="nav-menu w-100">
                        <ul class="primary-menu main-menu-ul d-flex align-items-center w-100">
                            ...
                            {{-- <li class="have-mega-menu"><a class="menu-parent-a @if ($current_route == 'home') active @endif" href="{{ route('home') }}">{{ get_phrase('Home') }}</a>
                                <ul class="mega-dropdown-menu mega main-mega-menu">
                                    <div class="mega-menu-items">
                                        <ul class="mega_list">
                                            @foreach (App\Models\BuilderPage::get() as $home_page)
                                                <li>
                            ...
                            <li class="have-mega-menu"><a
                                    class="menu-parent-a @if ($current_route == 'courses') active @endif"
                                    href="{{ route('courses') }}">{{ get_phrase('Courses') }}</a>
                                <ul class="mega-dropdown-menu mega main-mega-menu">
                                    <div class="mega-menu-items">
                                        <ul class="mega_list">
                                            @foreach ($parent_categories->take(10) as $parent_category)
                                                ...
                                                <li>
                                                    <a href="{{ route('courses', $parent_category->slug) }}">
                                                        <span class="me-3"><i
                                                                class="{{ $parent_category->icon }}"></i></span>
                                                        <span
                                                            class="me-auto">{{ ucfirst($parent_category->title) }}</span>
                                                    ...
                                                    @if ($child_categories->count() > 0)
                                                        <ul class="child_category_menu">
                                                            @foreach ($child_categories->get() as $child_category)
                                                                <li>
                                                                    <a
                                                                        href="{{ route('courses', $child_category->slug) }}">
            ...
            <div class="ms-lg-auto col-auto">
                <div class="primary-end d-flex align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @isset(auth()->user()->id)
                            <a href="{{ route('cart') }}" class="me-2 me-md-4 position-relative" data-bs-toggle="tooltip"
                            ...
                            <a href="{{ route('wishlist') }}" class="me-2 position-relative d-none d-lg-inline-block"
                                data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Wishlist') }}"
                        ...
                        @else
                            <a href="{{ route('cart') }}" class="ms-4 me-4 me-md-5 position-relative"
                                data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Cart') }}"
                                data-bs-placement="bottom">
                                <span class="cart-top-number">
                                    0
                                </span>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        d="M2 2H3.74001C4.82001 2 5.67 2.93 5.58 4L4.75 13.96C4.61 15.59 5.89999 16.99 7.53999 16.99H18.19C19.63 16.99 20.89 15.81 21 14.38L21.54 6.88C21.66 5.22 20.4 3.87 18.73 3.87H5.82001"
                                        stroke="#192335" stroke-width="1.5" stroke-miterlimit="10"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path
                                        d="M16.25 22C16.9404 22 17.5 21.4404 17.5 20.75C17.5 20.0596 16.9404 19.5 16.25 19.5C15.5596 19.5 15 20.0596 15 20.75C15 21.4404 15.5596 22 16.25 22Z"
                                        stroke="#192335" stroke-width="1.5" stroke-miterlimit="10"
                        ...
                        <div class="Userprofile me-0 me-md-2 ms-2 ms-md-3 d-none d-lg-inline-block">
                            ...
                            <ul class="dropdown-menu dropmenu-end " data-popper-placement="bottom-start">
                                    ...
                                    <li>
                                        <a class="dropdown-item"
                                            ...
                                            <svg width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                id="dashboard-icon" xmlns="http://www.w3.org/2000/svg">
                                ...
                                @if (Auth()->user()->role != 'admin')
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('my.bootcamps') }}"
                                            id="bootcamp-icon">
