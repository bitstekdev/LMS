<div class="tab-pane fade @if ($tab == 'certificate') show active @endif" id="pills-certificate" role="tabpanel"
    ...
    <div class="row justify-content-center my-4">
        <div class="col-md-6">
            ...
            @php
                $certificate = App\Models\Certificate::where('course_id', $course_details->id)->where(
                    'user_id',
                    auth()->user()->id,
                );
            @endphp
            @if ($certificate->count() > 0 && $course_progress_out_of_100 >= 100)
                <div class="alert alert-success text-center" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="progress" role="progressbar" aria-label="Warning example" aria-valuenow="75"
                                ...
                                <div class="progress-bar text-bg-warning"
                                    style="width: {{ $course_progress_out_of_100 }}%">
                    ...
                    <a class="btn btn-warning"
                        href="{{ route('certificate', ['identifier' => $certificate->value('identifier')]) }}">{{ get_phrase('Get Certificate') }}</a>
                </div>
            @else
