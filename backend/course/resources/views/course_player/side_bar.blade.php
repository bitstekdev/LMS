@php
    ...
    $completed_lesson =
        json_decode(
            App\Models\WatchHistory::where('course_id', $course_details->id)
    ...
    $lesson_history = App\Models\WatchHistory::where('course_id', $course_details->id)
        ->where('student_id', auth()->user()->id)
        ->firstOrNew();
                        ...
                        <div class="accordion-body">
                            <ul class="coourse-playlist-list">
                                @foreach ($lessons as $key => $lesson)
                                    ...
                                    <li
                                        class="coourse-playlist-item @if (
                                            (isset($history->watching_lesson_id) && $lesson->id == $history->watching_lesson_id) ||
                                                $lesson->id == $lesson_details->id) active @else lock @endif">
